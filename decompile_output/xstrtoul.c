...

{
  ...
  uVar17 = param_5;
  if (0x24 < param_3) goto code_r0x00114de5;
  unaff_R15 = param_2;
  if (param_2 == (byte **)0x0) {
    unaff_R15 = &pbStack72;
  }
  ...
  *piVar4 = 0;
  ...
  uVar7 = func_0x00103790(param_1,unaff_R15);
  puVar11 = *unaff_R15;
  if (puVar11 == param_1) {
...
code_r0x00114b38:
    ...
    uVar7 = 1;
    if (lVar8 == 0) goto code_r0x00114b38;
  }
  else {
    if (*piVar4 == 0) {
      unaff_RBP = 0;
      ...
      unaff_RBP = 1;
      if (*piVar4 != 0x22) goto code_r0x00114b38;
    }
  ...
  if (lVar8 == 0) goto code_r0x00114c7c;
...
code_r0x00114c7c:
  ...
  case 0x6b:
    ...
    if (SUB168(auVar3 * ZEXT816(puVar13) >> 0x40,0) == 0) goto code_r0x00114c60;
    break;
  case 0x4d:
  case 0x6d:
...
code_r0x00114c47:
  ...
  case 0x50:
    ...
    do {
      ...
      uVar16 = (int)uVar17 - 1;
      uVar17 = (ulong)uVar16;
      if (uVar16 == 0) goto code_r0x00114cd5;
    } while( true );
  case 0x54:
  case 0x74:
    uVar17 = 4;
