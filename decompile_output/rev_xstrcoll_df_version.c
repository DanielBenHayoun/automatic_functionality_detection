...
ulong rev_xstrcoll_df_version(byte **param_1,byte **param_2)

{
  ...
  uVar4 = func_0x00103590();
  uVar13 = (ulong)uVar4;
  if (uVar4 == 0) goto code_r0x0010d4c8;
  if (*pbVar7 == 0) {
code_r0x0010d608:
    uVar13 = 0xffffffff;
  }
...
code_r0x0010d41a:
          ...
          if ((((uint)bVar20 - 0x41 < 0x3a) &&
             ...
             (uVar4 = (uint)bVar20 + 0x100, bVar20 != 0x7e)) goto code_r0x0010d41a;
...
code_r0x0010d432:
          if (uVar12 != uVar4) goto code_r0x0010d5c8;
        }
        pbVar6 = pbVar6 + 1;
        pbVar10 = pbVar10 + 1;
      }
