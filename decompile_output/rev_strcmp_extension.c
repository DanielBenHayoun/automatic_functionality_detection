...
/* WARNING: Possible PIC construction at 0x0010b3d4: Changing call to branch */
/* WARNING: Removing unreachable block (ram,0x0010b3d9) */

void rev_strcmp_extension(long *param_1,undefined8 *param_2)
