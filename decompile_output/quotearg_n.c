...
undefined1 * quotearg_n(undefined1 *param_1,undefined8 param_2)

{
  ...
  if (-1 < iVar10) {
    ...
    uVar6 = quotearg_buffer_restyled
                      (puVar12,uVar2,param_2,0xffffffffffffffff,(ulong)default_quoting_options._0_4_
    ...
    if (uVar2 <= uVar6) {
      ...
      *(undefined1 **)(puVar9 + 1) = puVar12;
      quotearg_buffer_restyled
                (puVar12,uVar6,param_2,0xffffffffffffffff,(ulong)default_quoting_options._0_4_,
                 (ulong)uVar4,0x307208,default_quoting_options._40_8_,default_quoting_options._48_8_
                 ,puVar13);
    }
    *puVar5 = uVar1;
    return puVar12;
