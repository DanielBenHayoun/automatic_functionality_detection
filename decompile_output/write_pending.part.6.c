...
ulong write_pending_part_6(void)

{
  ...
  undefined8 auStack424 [3];
  undefined8 uStack400;
  byte *pbStack392;
  uint *apuStack384 [3];
  undefined8 *puStack360;
  int iStack352;
  byte abStack346 [2];
  byte *apbStack344 [3];
  uint uStack320;
  char acStack316 [4];
  undefined8 *apuStack312 [6];
  uint uStack264;
  byte abStack260 [4];
  undefined8 auStack256 [3];
  int iStack228;
  undefined8 auStack224 [3];
  uint auStack200 [6];
  undefined8 auStack176 [13];
  undefined8 auStack72 [3];
  
  bVar24 = 0;
  auStack72[2] = func_0x00101530(0,&UNK_00105504,5);
  puVar4 = (uint *)func_0x001014a0();
  puVar16 = (undefined8 *)(ulong)*puVar4;
  uStack320 = 1;
  func_0x001016e0(1,puVar16,auStack72[2]);
  bVar18 = 0;
  auStack72[0] = *(undefined8 *)(in_FS_OFFSET + 0x28);
  apbStack344[2] = puVar16;
  iVar2 = func_0x00101720();
  set_program_name(*puVar16);
...
code_r0x001023af:
      ...
      puVar14[-1] = SUB168(auVar25,0);
      *(undefined8 **)(puVar14 + -2) = puVar14 + -1;
      puVar14[-3] = 0x10240a;
      (*(code *)PTR___libc_start_main_00307fd0)
                (main,*puVar14,puVar14 + 1,__libc_csu_init,__libc_csu_fini,SUB168(auVar25 >> 0x40,0)
                );
      do {
...
code_r0x00101a6a:
    ...
    do {
      if (lVar10 == 0) break;
      lVar10 = lVar10 + -1;
      bVar22 = *pbVar6 < *pbVar17;
      bVar23 = *pbVar6 == *pbVar17;
      pbVar6 = pbVar6 + (ulong)bVar24 * -2 + 1;
    ...
    *(undefined4 *)((long)puVar14 + 4) = newlines2;
    unaff_R13B = bVar18 ^ 1;
    puVar20 = (undefined8 *)((lVar5 + (long)puVar19) - (ulong)(lVar5 + (long)puVar19) % uVar1);
    *(undefined8 **)(puVar14 + 4) = puVar20;
    puVar14[2] = (long)puVar20 + (long)puVar16;
    ...
    *(undefined4 *)((long)puVar14 + 0xac) = 0;
    ...
    do {
      ...
      if (puVar13 != (undefined8 *)0x0) {
        puVar16 = (undefined8 *)puVar14[4];
        puVar14[-1] = 0x101f08;
        puVar20 = (undefined8 *)full_write(1,puVar16,puVar13);
        puVar21 = puVar16;
      ...
      do {
        ...
        if (lVar10 != -1) {
          if (lVar10 != 0) {
            pbVar6 = (byte *)puVar14[3];
            pbVar7 = (byte *)puVar14[8];
            *(byte **)(puVar14 + 1) = pbVar6 + lVar10;
            pbVar6[lVar10] = 10;
      ...
      if (bVar15 < 0x20) {
        if ((bVar15 == 9) && (unaff_R13B != 0)) {
          ...
          *(undefined *)puVar20 = 0x5e;
          puVar19 = (undefined8 *)((long)puVar20 + 2);
          *(char *)((long)puVar20 + 1) = bVar15 + 0x40;
        }
      }
      else {
        if (bVar15 < 0x7f) {
          ...
          if (bVar15 == 0x7f) {
            ...
            *(undefined2 *)puVar20 = 0x2d4d;
            if (bVar15 < 0xa0) {
              ...
              *(char *)((long)puVar20 + 3) = bVar15 - 0x40;
            }
            else {
              if (bVar15 == 0xff) {
                puVar19 = (undefined8 *)((long)puVar20 + 4);
                ...
                *(byte *)((long)puVar20 + 2) = bVar15 + 0x80;
              }
            }
          }
        }
...
code_r0x00101da3:
  ...
  while( true ) {
    puVar14[-1] = 0x101dc0;
    puVar19 = (undefined8 *)full_write(1,lVar10,puVar16);
    if (puVar16 != puVar19) break;
    lVar10 = lVar10 + (long)puVar16;
    puVar19 = (undefined8 *)((long)puVar20 - lVar10);
    if (puVar19 < puVar16) goto code_r0x00101dd7;
  }
  puVar14[-1] = 0x1022e1;
  uVar9 = func_0x00101530(0,&UNK_00105504,5);
  puVar14[-1] = 0x1022e9;
...
code_r0x00101dd7:
  ...
  *(undefined8 **)(puVar14 + 5) = puVar19;
  puVar14[-1] = 0x101def;
  func_0x001016d0(lVar5,lVar10,puVar19);
  puVar20 = (undefined8 *)(lVar5 + puVar14[5]);
  pbVar6 = pbVar7;
  puVar19 = puVar16;
...
code_r0x00102074:
  ...
  do {
    if (lVar10 == 0) break;
    lVar10 = lVar10 + -1;
    bVar22 = *pbVar7 < *pbVar6;
    bVar23 = *pbVar7 == *pbVar6;
...
code_r0x0010221f:
  ...
  if ((undefined8 *)puVar14[7] <= puVar16) {
    puVar20 = puVar16;
  }
  puVar14[-1] = 0x102237;
