...
ulong strcmp_df_mtime(undefined8 *param_1,undefined8 *param_2)

{
  ...
  if ((*(int *)(param_1 + 0x15) == 3) || (*(int *)(param_1 + 0x15) == 9)) {
    if (iVar1 == 3 || iVar1 == 9) goto code_r0x00106a08;
...
code_r0x00106a08:
  ...
  if (lVar2 <= lVar3) {
    uVar5 = (int)param_2[0xf] - *(int *)(param_1 + 0xf);
    if (uVar5 == 0) {
