...
ulong strcmp_df_atime(undefined8 *param_1,undefined8 *param_2)

{
  ...
  if ((*(int *)(param_1 + 0x15) == 3) || (*(int *)(param_1 + 0x15) == 9)) {
    if (iVar1 == 3 || iVar1 == 9) goto code_r0x0010b678;
...
code_r0x0010b678:
  ...
  if (lVar2 <= lVar3) {
    uVar5 = (int)param_2[0xd] - *(int *)(param_1 + 0xd);
    if (uVar5 == 0) {
