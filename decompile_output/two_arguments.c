...
code_r0x001026c0:
  do {
    ...
    pbVar19 = pbVar24;
    pbVar21 = &UNK_00107e18;
    do {
      uVar3 = (uint)pbVar21;
      if (lVar12 == 0) break;
      lVar12 = lVar12 + -1;
      uVar3 = (uint)(pbVar21 + (ulong)bVar29 * -2 + 1);
      in_CF = *pbVar19 < *pbVar21;
      in_ZF = *pbVar19 == *pbVar21;
    ...
    if (((*pbVar24 == 0x2d) && (pbVar24[1] != 0)) && (pbVar24[2] == 0)) {
      ...
      *(undefined8 *)((undefined *)register0x00000020 + -0x20) =
      ...
      case 0x47:
        ...
        *(undefined8 *)((undefined *)register0x00000020 + -0xc0) = 0x102629;
        ...
        uVar22 = uVar10 & 0xffffffffffffff00 |
...
code_r0x0010265a:
      ...
      case 0x68:
        ...
        *(undefined8 *)((undefined *)register0x00000020 + -0xc0) = 0x1025c6;
        ...
        uVar22 = 0;
        if (iVar5 == 0) {
          uVar22 = (ulong)(*(uint *)((undefined *)register0x00000020 + -0xa0) & 0xf000 |
                          (uint)((*(uint *)((undefined *)register0x00000020 + -0xa0) & 0xf000) ==
                                0xa000));
        }
        break;
      case 0x4e:
        ...
        *(undefined8 *)((undefined *)register0x00000020 + -0xc0) = 0x10256e;
        ...
        if ((*(long *)((undefined *)register0x00000020 + -0x70) == lVar7 || lVar12 < lVar7) &&
           (uVar22 = 1, lVar7 <= lVar12)) {
          uVar22 = (ulong)(0 < (int)*(undefined8 *)((undefined *)register0x00000020 + -0x58) -
...
code_r0x00102546:
      ...
      case 0x65:
        ...
        *(undefined8 *)((undefined *)register0x00000020 + -0xc0) = 0x10240e;
        uVar22 = func_0x001014d0(1,pbVar24,(undefined *)register0x00000020 + -0xb8);
        uVar22 = uVar22 & 0xffffffffffffff00 | (ulong)((int)uVar22 == 0);
        break;
      case 0x66:
      ...
      case 0x67:
        ...
        *(undefined8 *)((undefined *)register0x00000020 + -0xc0) = 0x10238e;
        ...
        uVar22 = 0;
        if (iVar5 == 0) {
          uVar22 = (ulong)(*(uint *)((undefined *)register0x00000020 + -0xa0) >> 10 & 1);
        }
        break;
      case 0x6b:
        ...
        *(undefined8 *)((undefined *)register0x00000020 + -0xc0) = 0x10234e;
        ...
        uVar22 = 0;
        if (iVar5 == 0) {
          uVar22 = (ulong)(*(uint *)((undefined *)register0x00000020 + -0xa0) >> 9 & 1);
        }
        break;
      case 0x6e:
        *(undefined8 *)((undefined *)register0x00000020 + -0xc0) = 0x102315;
        unary_advance();
        uVar22 = (ulong)ppbVar15[(long)(int)pos + -1] & 0xffffffffffffff00 |
      ...
      case 0x72:
        ...
        *(undefined8 *)((undefined *)register0x00000020 + -0xc0) = 0x1022bb;
        uVar22 = func_0x00101580(pbVar24,4);
        uVar22 = uVar22 & 0xffffffffffffff00 | (ulong)((int)uVar22 == 0);
        break;
      case 0x73:
        ...
        *(undefined8 *)((undefined *)register0x00000020 + -0xc0) = 0x102286;
        ...
        uVar22 = 0;
        if (iVar5 == 0) {
          uVar22 = (ulong)(0 < *(long *)((undefined *)register0x00000020 + -0x88));
        }
        break;
      case 0x74:
      ...
      case 0x75:
        ...
        *(undefined8 *)((undefined *)register0x00000020 + -0xc0) = 0x1021be;
        ...
        uVar22 = 0;
        if (iVar5 == 0) {
          uVar22 = (ulong)(*(uint *)((undefined *)register0x00000020 + -0xa0) >> 0xb & 1);
        }
        break;
      case 0x77:
        ...
        *(undefined8 *)((undefined *)register0x00000020 + -0xc0) = 0x10225b;
        uVar22 = func_0x00101580(pbVar24,2);
        uVar22 = uVar22 & 0xffffffffffffff00 | (ulong)((int)uVar22 == 0);
        break;
      case 0x78:
        ...
        *(undefined8 *)((undefined *)register0x00000020 + -0xc0) = 0x102193;
        uVar22 = func_0x00101580(pbVar24,1);
        uVar22 = uVar22 & 0xffffffffffffff00 | (ulong)((int)uVar22 == 0);
        break;
      case 0x7a:
      ...
      in_CF = false;
      in_ZF = *(long *)((undefined *)register0x00000020 + -0x20) == *(long *)(in_FS_OFFSET + 0x28);
      if (in_ZF) {
        return uVar22;
      }
    ...
    *(undefined8 *)((undefined *)register0x00000020 + -0x10) = 0x102730;
    beyond();
    if (uVar3 != 2) break;
    in_CF = (undefined *)0xfffffffffffffff7 < (undefined *)register0x00000020 + -0x10;
    in_ZF = (undefined *)register0x00000020 == (undefined *)0x8;
    register0x00000020 = (BADSPACEBASE *)((undefined *)register0x00000020 + -8);
  } while( true );
  if ((int)uVar3 < 3) {
    if (uVar3 == 1) {
      uVar22 = (ulong)argv[(int)pos] & 0xffffffffffffff00 | (ulong)(*argv[(int)pos] != 0);
code_r0x001027e6:
      pos = pos + 1;
      return uVar22;
    }
code_r0x001027f6:
    ...
    do {
      if (lVar12 == 0) break;
      lVar12 = lVar12 + -1;
      bVar26 = *pbVar24 < *pbVar19;
      bVar28 = *pbVar24 == *pbVar19;
      ...
      if (bVar26) {
        ...
        if ((!bVar28 && !bVar26) == bVar28) {
          ...
          *(undefined8 *)((undefined *)register0x00000020 + -0x18) = 0x10285e;
          uVar22 = two_arguments();
          goto code_r0x001027e6;
        }
      }
      goto code_r0x001027f6;
    }
    pos = pos + 1;
    if ((int)pos < (int)argc) {
...
code_r0x00102898:
  ...
  do {
    unaff_R15 = argv;
    cVar1 = (char)lVar12;
    ppbVar15 = (byte **)(long)(int)pos;
    ppbVar11 = (byte **)argv[(long)ppbVar15];
    ...
    if (*(byte *)ppbVar11 == 0x21) {
      ...
      uVar23 = pos + 1;
      ppbVar15 = (byte **)(ulong)uVar23;
      uVar4 = uVar23;
      if ((int)uVar23 < iVar5) {
        ppbVar15 = (byte **)(long)(int)uVar23;
        cVar1 = '\0';
        unaff_R14 = 1;
        ppbVar18 = (byte **)((long)ppbVar15 + (ulong)((iVar5 + -2) - pos) + 1);
        while( true ) {
          ...
          uVar4 = uVar3 + 1;
          if (ppbVar15 == ppbVar18) goto code_r0x00102a5e;
...
joined_r0x00102b06:
        ...
        bVar26 = uVar23 < pos;
        bVar28 = uVar23 == pos;
        if ((int)uVar23 <= (int)pos) goto code_r0x00102ae7;
      }
      else {
        lVar7 = 3;
        ppbVar18 = ppbVar11;
        ...
        do {
          if (lVar7 == 0) break;
          lVar7 = lVar7 + -1;
          bVar26 = *(byte *)ppbVar18 < *pbVar24;
          bVar28 = *(byte *)ppbVar18 == *pbVar24;
          ppbVar18 = (byte **)((long)ppbVar18 + (ulong)bVar29 * -2 + 1);
          pbVar24 = pbVar24 + (ulong)bVar29 * -2 + 1;
        } while (bVar28);
        if ((!bVar26 && !bVar28) == bVar26) {
          pbVar24 = unaff_R15[(long)ppbVar15 + 2];
...
code_r0x00102aaf:
          pbVar24 = unaff_R15[(long)ppbVar15 + 1];
...
code_r0x00102ae7:
      ...
      lVar12 = 3;
      pbVar19 = pbVar24;
      pbVar21 = &UNK_00107e3e;
      do {
        if (lVar12 == 0) break;
        lVar12 = lVar12 + -1;
        bVar26 = *pbVar19 < *pbVar21;
        bVar28 = *pbVar19 == *pbVar21;
        pbVar19 = pbVar19 + (ulong)bVar29 * -2 + 1;
        pbVar21 = pbVar21 + (ulong)bVar29 * -2 + 1;
      } while (bVar28);
      cVar1 = (char)lVar12;
      if ((!bVar26 && !bVar28) != bVar26) {
        lVar12 = 3;
        pbVar19 = puVar17 + -0x39;
        bVar26 = false;
        *pbVar19 = *pbVar19 | (byte)uVar14;
        bVar28 = *pbVar19 == 0;
  ...
  while( true ) {
    ...
    uVar22 = (ulong)uVar23;
    ppbVar11 = ppbVar11 + 1;
    bVar26 = uVar4 - uVar3 < uVar23;
    bVar28 = uVar4 - uVar3 == uVar23;
    if (bVar28) break;
    lVar7 = 2;
    pbVar24 = *ppbVar11;
    pbVar19 = &UNK_00109349;
    ...
    if ((int)uVar22 == 4) {
      uVar22 = (ulong)(iVar5 - pos);
      break;
    }
  }
code_r0x001029c8:
  *(undefined8 *)(puVar17 + -0x50) = 0x1029d0;
  uVar3 = posixtest(uVar22);
  pbVar24 = argv[(int)pos];
  if (pbVar24 != (byte *)0x0) {
  ...
  *(undefined8 *)(puVar17 + -0x10) = 0x102c7a;
  ...
  if (!bVar28) {
    ...
    *(undefined8 *)(puVar17 + -0x40) = *(undefined8 *)(in_FS_OFFSET + 0x28);
    ...
    pbVar19 = &UNK_00107dc6;
    goto code_r0x00101bd8;
  }
  lVar13 = 2;
  pbVar19 = ppbVar11[lVar12];
  pbVar21 = &UNK_00107e18;
  do {
    pbVar20 = pbVar21;
    if (lVar13 == 0) break;
    lVar13 = lVar13 + -1;
    pbVar20 = pbVar21 + (ulong)bVar29 * -2 + 1;
    bVar26 = *pbVar19 < *pbVar21;
    bVar28 = *pbVar19 == *pbVar21;
    pbVar19 = pbVar19 + (ulong)bVar29 * -2 + 1;
    pbVar21 = pbVar20;
  ...
  if (!bVar26) {
    ...
    if (bVar26) {
      lVar13 = 2;
      pbVar19 = ppbVar11[lVar12 + 2];
      pbVar21 = &UNK_00109349;
      do {
        if (lVar13 == 0) break;
        lVar13 = lVar13 + -1;
        bVar28 = *pbVar19 < *pbVar21;
      ...
      if (bVar26) {
        pos = uVar3 + 3;
        return uVar22 & 0xffffffffffffff00 | (ulong)(*pbVar24 != 0);
      }
    }
    bVar28 = false;
    lVar12 = 3;
    ...
    if (!bVar26) {
      ...
      if ((!bVar27 && !bVar26) != bVar27) {
        ...
        *(undefined8 *)(puVar17 + -0x10) = 0x102d93;
        test_syntax_error(pbVar20,lVar7);
        goto code_r0x00102d93;
      }
    }
    ppbVar15 = (byte **)(ulong)uVar3;
    if ((int)argc <= (int)uVar3) goto code_r0x00102d93;
    unaff_RBX = *(byte ***)(puVar17 + -8);
    goto or;
  }
  pos = uVar3 + 1;
  if ((int)pos < (int)argc) {
...
code_r0x00102dfd:
    ...
    *(undefined8 *)(puVar17 + -0x58) = 0x107ea4;
    ...
    do {
      ...
      if (bVar28) break;
      lVar7 = 5;
      pbVar19 = &UNK_00107e61;
      do {
        if (lVar7 == 0) break;
        lVar7 = lVar7 + -1;
        bVar26 = *pbVar19 < *pbVar24;
...
code_r0x00101e91:
      ...
      *(undefined8 *)(puVar17 + -0x1b0) = 0x101ece;
      ...
      pos = pos + 3;
      if (bVar29 == 0x6c) {
        uVar22 = (ulong)(iVar5 < (int)(uint)bVar26);
      }
      else {
        if (bVar29 == 0x67) {
          uVar22 = (ulong)((int)-(uint)bVar26 < iVar5);
        }
        else {
          uVar22 = (ulong)((iVar5 != 0) == bVar26);
        }
      }
          ...
          if (iVar5 == 0) {
            ...
            *(undefined8 *)(puVar17 + -0x1b0) = 0x101e33;
            ...
            if ((iVar5 == 0) && (*(long *)(puVar17 + -0x198) == *(long *)(puVar17 + -0x108))) {
              uVar22 = (ulong)(*(long *)(puVar17 + -400) == *(long *)(puVar17 + -0x100));
            }
          }
          goto code_r0x00101c4f;
        }
        ...
        *(undefined8 *)(puVar17 + -0x1b0) = 0x101f77;
        ...
        if (iVar5 == 0) {
          if ((*(long *)(puVar17 + -0xb0) <= lVar7) &&
             (uVar22 = 1, lVar7 <= *(long *)(puVar17 + -0xb0))) {
            uVar22 = (ulong)(0 < (int)uVar6 - (int)*(undefined8 *)(puVar17 + -0xa8));
          }
        }
        else {
          uVar22 = 1;
...
code_r0x00101f9a:
    ...
    if (cVar1 == '\0') {
      ...
      *(undefined8 *)(puVar17 + -0x1b0) = 0x101d8c;
      ...
      if (iVar2 == 0) {
        lVar7 = *(long *)(puVar17 + -0xb0);
        uVar22 = (ulong)(iVar5 != 0 || (long)unaff_R12 < lVar7);
        if ((iVar5 == 0 && (long)unaff_R12 >= lVar7) && ((long)unaff_R12 <= lVar7)) {
          uVar22 = (ulong)((uint)(*(int *)(puVar17 + -0x1a0) - (int)*(undefined8 *)(puVar17 + -0xa8)
                                 ) >> 0x1f);
        }
      }
      goto code_r0x00101c4f;
...
code_r0x00101cb8:
        ...
        pbVar19 = argv[(long)(int)pos];
        *(undefined8 *)(puVar17 + -0x1b0) = 0x101cd4;
        iVar5 = func_0x00101490(pbVar19,pbVar24);
        uVar22 = (ulong)(iVar5 == 0);
        pos = uVar3 + 3;
        goto code_r0x00101c4f;
      }
      bVar26 = bVar9 < 0x3d;
