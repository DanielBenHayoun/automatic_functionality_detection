...

{
  ...
  if (puVar10 != (uint *)0x0) {
    puVar9 = puVar10;
    uVar3 = func_0x00102ae0(puVar10,1,uStack2064,param_1);
    if (uVar3 < uVar8) {
      uVar8 = 0xffffffff;
      ...
      goto code_r0x0010b7f6;
    }
    if (puVar10 != auStack2056) {
      func_0x00102710();
      puVar9 = puVar10;
    }
    if (uVar8 < 0x80000000) goto code_r0x0010b7f6;
    puVar4 = (undefined4 *)func_0x00102750();
    *puVar4 = 0x4b;
  }
  uVar8 = 0xffffffff;
