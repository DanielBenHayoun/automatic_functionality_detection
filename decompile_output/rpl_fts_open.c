...

{
  ...
  plVar5 = (long *)func_0x00101b90(0x80,1);
  if (plVar5 == (long *)0x0) {
    return (long *)0;
  }
  plVar5[8] = param_3;
  if ((param_2 & 2) == 0) {
    ...
    *(undefined4 *)((long)plVar5 + 0x2c) = 0xffffff9c;
    if (lVar8 != 0) goto code_r0x0010801e;
code_r0x0010827f:
    uVar11 = 0x1000;
  }
  else {
    ...
    *(uint *)(plVar5 + 9) = param_2 & 0xfffffdff | 4;
    if (lVar8 == 0) goto code_r0x0010827f;
code_r0x0010801e:
    uVar11 = 0;
    plVar13 = param_1;
    do {
      uVar6 = func_0x00101a80();
      if (uVar11 < uVar6) {
        uVar11 = uVar6;
      }
      plVar13 = plVar13 + 1;
  ...
  if (bStack66 == 0) goto code_r0x00108309;
  lVar8 = *param_1;
  if (lVar8 == 0) {
    lVar7 = 0;
    if (param_3 != 0) {
code_r0x001080b0:
      ...
      goto code_r0x001080bd;
    }
code_r0x0010832c:
    lVar9 = 0;
code_r0x001081cc:
    lVar8 = fts_alloc(plVar5,&UNK_0010be81,0);
    *plVar5 = lVar8;
    if (lVar8 != 0) {
      uVar1 = *(uint *)(plVar5 + 9);
...
code_r0x001082f0:
    fts_lfree(lVar9);
    func_0x00101da0(lVar7);
  }
  else {
    lVar7 = fts_alloc(plVar5,&UNK_0010be81,0);
    if (lVar7 != 0) {
      lVar8 = *param_1;
      *(undefined8 *)(lVar7 + 0x58) = 0xffffffffffffffff;
      *(undefined8 *)(lVar7 + 0x68) = 0xffffffffffffffff;
      if (param_3 != 0) goto code_r0x001080b0;
code_r0x001080bd:
      if (lVar8 == 0) goto code_r0x0010832c;
      lStack64 = 0;
      uVar11 = 0;
      lVar12 = 0;
      do {
        uVar6 = func_0x00101a80(lVar8);
        ...
        lVar9 = lVar12;
        if (lVar8 == 0) goto code_r0x001082f0;
        ...
        *(long *)(lVar8 + 0x30) = lVar8 + 0x108;
        ...
        if ((lVar12 == 0) || (bStack66 == 0)) {
          ...
          *(undefined2 *)(lVar8 + 0x70) = uVar3;
          if (param_3 != 0) goto code_r0x00108147;
          *(undefined8 *)(lVar8 + 0x10) = 0;
          if (lVar12 != 0) goto code_r0x001082d8;
        }
        else {
...
code_r0x00108147:
      ...
      goto code_r0x001081cc;
    }
  }
  func_0x00101da0(plVar5[4]);
code_r0x00108309:
  func_0x00101da0(plVar5);
  return (long *)0;
}
