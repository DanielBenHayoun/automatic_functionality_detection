...

{
  ...
  while( true ) {
    ...
    *(undefined8 *)(puVar9 + -0x50) = 0x105f93;
    uVar3 = last_component(param_1);
    *(undefined8 *)(puVar9 + -0x50) = 0x105f9e;
    uVar4 = last_component(puVar7);
    *(undefined8 *)(puVar9 + -0x50) = 0x105fa9;
    lVar5 = base_len(uVar3);
    *(undefined8 *)(puVar9 + -0x50) = 0x105fb4;
    lVar6 = base_len(uVar4);
    if (lVar5 != lVar6) {
      return 0;
    }
    *(undefined8 *)(puVar9 + -0x50) = 0x105fde;
    ...
    *(undefined8 *)(puVar9 + -0x160) = 0x105e70;
    uVar3 = dir_name(param_1);
    *(undefined8 *)(puVar9 + -0x160) = 0x105e8c;
    iVar1 = func_0x001015c0(1,unaff_R13,uVar3,puVar9 + -0x158,0x100);
    if (iVar1 != 0) {
      *(undefined8 *)(puVar9 + -0x160) = 0x105f45;
      puVar2 = (uint *)func_0x001014d0();
      uVar10 = *puVar2;
      *(undefined8 *)(puVar9 + -0x160) = 0x105f5d;
      func_0x00101720(1,(ulong)uVar10,&UNK_0010750d,uVar3);
    }
    *(undefined8 *)(puVar9 + -0x160) = 0x105e9c;
    func_0x001014b0(uVar3);
    *(undefined8 *)(puVar9 + -0x160) = 0x105ea4;
    unaff_RBX = (undefined *)dir_name(puVar7);
    param_2 = puVar9 + -200;
    *(undefined8 *)(puVar9 + -0x160) = 0x105ec4;
    iVar1 = func_0x001015c0(1,uVar8,unaff_RBX,param_2,0x100);
    param_1 = uVar8;
    if (iVar1 != 0) {
      *(undefined8 *)(puVar9 + -0x160) = 0x105f1d;
      puVar2 = (uint *)func_0x001014d0();
      param_1 = (ulong)*puVar2;
      *(undefined8 *)(puVar9 + -0x160) = 0x105f35;
      param_2 = unaff_RBX;
      func_0x00101720(1,param_1,&UNK_0010750d);
    }
    uVar10 = 0;
    ...
    *(undefined8 *)(puVar9 + -0x160) = 0x105ef1;
    puVar11 = unaff_RBX;
    func_0x001014b0();
    if (*(long *)(puVar9 + -0x30) == *(long *)(in_FS_OFFSET + 0x28)) {
      return unaff_RBP;
    }
    *(undefined8 *)(puVar9 + -0x160) = 0x105f67;
    func_0x00101590();
    uVar8 = extraout_RDX;
    puVar9 = puVar9 + -0x158;
    unaff_R12 = puVar7;
