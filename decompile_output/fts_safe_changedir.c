...
code_r0x001072c5:
      if (((uVar1 & 0x200) != 0) && (-1 < iVar2)) {
        uVar7 = 0;
        func_0x00101b50(param_3);
        goto code_r0x001072d5;
      }
      uVar7 = 0;
      goto code_r0x001072d5;
    }
    ...
    if ((!bVar12 && !bVar13) != bVar12) goto code_r0x001072c0;
    if ((uVar1 & 4) != 0) goto code_r0x001072c5;
    if (-1 < iVar2) goto code_r0x0010742a;
    if ((uVar1 & 0x200) == 0) {
code_r0x0010724f:
      bStack217 = 1;
    }
      ...
      if (bStack217 == 0) {
        ...
        if (-1 < (int)uVar3) {
          param_3 = (ulong)uVar3;
          bStack217 = 1;
          if ((uVar1 & 2) == 0) goto code_r0x00107340;
          goto code_r0x00107280;
        }
        goto code_r0x0010724f;
      }
    }
code_r0x00107254:
  ...
  if ((uVar1 & 2) == 0) {
    ...
    if (bVar12) goto code_r0x00107340;
    pbVar6 = &UNK_0010b4ae;
    goto code_r0x00107326;
  }
code_r0x00107280:
  iVar2 = func_0x00101c50(1,uVar11,&lStack216);
  if (iVar2 == 0) {
    if ((*(long *)(param_2 + 0x78) == lStack216) && (*(long *)(param_2 + 0x80) == lStack208)) {
      bVar8 = (byte)((ulong)*(uint *)(param_1 + 0x48) >> 8);
      goto code_r0x00107340;
    }
...
code_r0x0010729f:
  if ((int)param_3 < 0) {
    param_4 = (uint *)func_0x001019a0();
    uVar1 = *param_4;
    param_3 = (ulong)uVar1;
    func_0x00101b50(uVar11);
    *param_4 = uVar1;
  }
code_r0x001072d5:
  do {
...
code_r0x0010742a:
    ...
    bStack217 = 1;
    uVar11 = param_3;
    if (!bVar12) goto code_r0x00107280;
code_r0x00107326:
    bVar13 = false;
    lVar5 = 3;
    puVar9 = param_4;
    ...
    if ((!bVar13 && !bVar12) == bVar13) goto code_r0x00107280;
code_r0x00107340:
    if ((bVar8 & 2) == 0) break;
    uVar7 = 0;
  ...
  uVar1 = func_0x00101c70();
  uVar7 = (ulong)uVar1;
  goto code_r0x0010729f;
}
