...
ulong md5sum(uint param_1,undefined8 *param_2)

{
  ...
  func_0x00101800(6,&UNK_00107fc1);
  func_0x00101650(&UNK_00106eb8,&UNK_00106ee1);
  func_0x00101630(&UNK_00106eb8);
  atexit(close_stdout);
  ...
  do {
    while( true ) {
      ...
      *(undefined8 *)(puVar17 + -8) = 0x1019b4;
      iVar5 = func_0x001016a0(puVar23,param_2,&UNK_00106f22,long_options);
      if (iVar5 == -1) {
    ...
    if (iVar5 == 0x62) {
      ...
      if (iVar5 < 99) {
        if (iVar5 == -0x83) {
          ...
          *(undefined8 *)(puVar17 + -0x10) = 0x106f15;
          *(undefined8 *)(puVar17 + -0x18) = 0x101a96;
          version_etc(stdout,&UNK_00106e2a,&UNK_00106eb4,Version);
...
code_r0x00101bda:
          unaff_R15 = uVar13;
          if (((puVar17[0x2b] == '\0') || (puVar19 = &UNK_00107668, puVar17[0x78] == '\0')) &&
             (((int)pbVar18 < 0 || (puVar19 = &UNK_001076a8, puVar17[0x2b] == '\0')))) {
            if (ignore_missing == '\0') goto code_r0x001029e8;
            if (puVar17[0x2b] == '\0') {
code_r0x00102a2c:
              puVar19 = &UNK_001076f8;
            }
            else {
...
code_r0x001027fd:
                  ...
                  do {
                    ...
                    *(undefined8 *)(puVar17 + -8) = 0x1024cc;
                    func_0x00101810(1,&UNK_00106f99,(ulong)bVar4);
                ...
                *(int *)(puVar17 + 0x2c) = (int)cVar3;
                if (cVar3 == '\0') {
                  ...
                  *(undefined8 *)(puVar17 + -8) = 0x101d04;
                  uVar7 = func_0x00101660(0,&UNK_00106f28,5);
                  *(undefined8 *)(puVar17 + 0x20) = uVar7;
                  puVar23 = stdin;
                }
                else {
                  *(undefined8 *)(puVar17 + -8) = 0x102426;
                  puVar23 = (uint *)fopen_safer(*(undefined8 *)(puVar17 + 0x20),&UNK_00106f04);
...
code_r0x00101e44:
                  ...
                  if (warn != '\0') {
                    ...
                    *(undefined8 *)(puVar17 + -8) = 0x1021f7;
                    uVar8 = func_0x00101660(0,&UNK_00107840,5);
...
code_r0x00102432:
                          ...
                          *(undefined8 *)(puVar17 + -8) = 0x102460;
                          func_0x00101830(0,(ulong)uVar1,&UNK_001079f5,param_2);
                          bVar4 = 0;
                      ...
                      if (puVar17[0x30] == '\0') {
                        ...
                        *(undefined8 *)(puVar17 + -8) = 0x10266c;
                        uVar7 = func_0x00101660(0,&UNK_00107870,5);
                        pbVar22 = &UNK_00106e31;
                        ...
                        if (status_only == '\0') {
                          if (unaff_R13 != 0) {
                            ...
                            *(undefined8 *)(puVar17 + -8) = 0x1020fc;
                            uVar7 = func_0x00101860(0,&UNK_001078d8,&UNK_001078a8,unaff_R13);
                          ...
                          if (*(long *)(puVar17 + 0x50) != 0) {
                            ...
                            *(undefined8 *)(puVar17 + -8) = 0x102138;
                            uVar7 = func_0x00101860(0,&UNK_00107938,&UNK_00107908,uVar13);
                          ...
                          if (*(long *)(puVar17 + 0x58) != 0) {
                            ...
                            *(undefined8 *)(puVar17 + -8) = 0x102174;
                            uVar7 = func_0x00101860(0,&UNK_00107998,&UNK_00107968,uVar13);
                          ...
                          if (puVar17[0x7a] == '\0') {
                            ...
                            *(undefined8 *)(puVar17 + -8) = 0x10291e;
                            uVar7 = func_0x00101660(0,&UNK_00106f80,5);
...
code_r0x001021be:
                      ...
                      *(undefined8 *)(puVar17 + -8) = 0x102595;
                      uVar7 = func_0x00101660(0,&UNK_00106f71,5);
...
code_r0x00102383:
                    if (have_read_stdin != '\0') {
                      ...
                      *(undefined8 *)(puVar17 + -8) = 0x102728;
                      pbVar16 = (byte *)func_0x00101660(0,&UNK_00106f28,5);
...
code_r0x0010232d:
                                puVar19 = &UNK_00106f67;
                                goto code_r0x0010206b;
                              }
                            }
                            if (quiet == '\0') {
                              puVar19 = &UNK_00106f6e;
                              goto code_r0x0010206b;
                            }
                          }
                        }
...
code_r0x00101e60:
                ...
                *(undefined8 *)(puVar17 + -8) = 0x101e91;
                uVar7 = func_0x00101660(0,&UNK_00106f37,5);
                *(undefined8 *)(puVar17 + -8) = 0x101ea5;
                func_0x00101830(1,0,uVar7,param_2);
code_r0x00101ea5:
                unaff_R15 = uVar13;
                if ((quiet == '\x01') && (puVar19 = &UNK_001077c0, puVar17[0x2b] == '\0')) break;
code_r0x00101ec5:
                uVar13 = unaff_R15;
              } while ((strict == 0) || (puVar19 = &UNK_00107800, puVar17[0x2b] != '\0'));
            }
          }
code_r0x00101bbb:
