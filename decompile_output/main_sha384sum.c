...
ulong sha384sum(uint param_1,undefined8 *param_2)

{
  ...
  bool bVar25;
  byte bVar26;
  undefined8 *apuStack368 [3];
  undefined auStack344 [8];
  byte **appbStack336 [2];
  ulong uStack320;
  byte *pbStack312;
  undefined uStack301;
...
code_r0x00102533:
                ...
                *(undefined **)(puVar17 + 0x38) = puVar17 + 0xe0;
                do {
...
code_r0x00102390:
                    if (*(long *)(puVar17 + 0x118) == *(long *)(in_FS_OFFSET + 0x28)) {
