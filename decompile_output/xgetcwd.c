...

{
  ...
  lStack48 = func_0x00103520(0,0);
  if ((lStack48 != 0) || (piVar6 = (int *)func_0x001032a0(), *piVar6 != 0xc)) {
    return (uint *)lStack48;
  }
  xalloc_die();
  pbVar8 = (byte *)0x0;
  plStack96 = &lStack64;
  ...
  do {
    while( true ) {
      pbVar8 = (byte *)x2realloc(pbVar8,&lStack64);
      puStack80 = (ulong *)(pbVar8 + lStack64 + -2);
      ppbVar16 = (byte **)(lStack64 + -1);
      *(byte *)puStack80 = 0;
      *puVar15 = 0;
      pbVar18 = pbVar8;
      ...
      if (iVar5 != 0) break;
      pbStack112 = pbVar8;
      if (*(byte *)puStack80 == 0) goto code_r0x001149f8;
    }
    uVar14 = *puVar15;
    puStack80 = (ulong *)(ulong)uVar14;
  } while ((uVar14 < 0x25) && (((ulong)puVar15 >> ((ulong)puStack80 & 0x1f) & 1) != 0));
  pbStack112 = (byte *)0x0;
  func_0x00103880();
  *puVar15 = uVar14;
  pbVar18 = pbVar8;
code_r0x001149f8:
  if (lStack56 == *(long *)(in_FS_OFFSET + 0x28)) {
    return (uint *)pbStack112;
  }
  func_0x00103420();
  uStack88 = 0x1000401001;
