...

{
  ...
  if (((uVar11 & uVar11 - 1) == 0) && (param_1 != (char *)0x0)) {
    if (*param_1 == '\0') {
      puVar7 = (undefined4 *)func_0x001032a0();
      pcVar10 = (char *)0x0;
      *puVar7 = 2;
      pcStack264 = param_1;
    }
    else {
      if (*param_1 == '/') goto code_r0x0010ca60;
      pcStack264 = param_1;
      pcVar10 = (char *)xgetcwd();
      if (pcVar10 != (char *)0x0) {
        uVar4 = func_0x00103400(pcVar10);
        pcVar14 = param_1;
        if (uVar4 < 0x1000) {
...
code_r0x0010c70f:
        ...
        if (cVar2 == '/') {
          ...
          param_1 = pcVar14;
          if (cVar2 != '\0') goto code_r0x0010c63d;
        }
        else {
code_r0x0010c63d:
          do {
        ...
        if (pcVar14 == param_1) goto code_r0x0010c70f;
        pcVar12 = pcVar14 + -(long)param_1;
        pcStack264 = pcVar17;
        if (pcVar12 == (char *)0x1) {
          if (cVar2 != '.') goto code_r0x0010c671;
          goto code_r0x0010c700;
        }
        if (((pcVar12 == (char *)0x2) && (cVar2 == '.')) && (param_1[1] == '.')) {
          pcVar17 = pcVar16;
          if (((pcVar16 <= pcVar10 + 1) || (pcVar17 = pcVar16 + -1, pcVar17 <= pcVar10)) ||
             (pcVar16[-2] == '/')) goto code_r0x0010c5fb;
          do {
            pcVar16 = pcVar17 + -1;
...
code_r0x0010c671:
          ...
          func_0x001035f0(pcVar16,param_1,pcVar12);
...
code_r0x0010c6ee:
            if ((*pcVar14 != '\0') && (uVar11 != 2)) {
              piVar13 = (int *)func_0x001032a0();
              iVar3 = 0x14;
code_r0x0010c801:
              func_0x00103880(pcStack240);
              func_0x00103880();
              pcStack264 = pcVar10;
              if (pcVar17 != (char *)0x0) {
code_r0x0010c8ca:
          ...
          if ((param_2 & 4) == 0) {
            iVar3 = func_0x00103410(1,pcVar10,auStack216);
          }
          else {
            iVar3 = func_0x00103640();
          }
          if (iVar3 != 0) {
            piVar13 = (int *)func_0x001032a0();
            iVar3 = *piVar13;
            if ((param_2 & 3) != 0) {
              if (uVar11 != 1) goto code_r0x0010c6e6;
              lVar5 = func_0x00103530(pcVar14,&UNK_00117bbb);
              if ((pcVar14[lVar5] == '\0') && (iVar3 == 2)) goto code_r0x0010c700;
            }
            goto code_r0x0010c801;
          }
          if ((uStack192 & 0xf000) == 0xa000) {
            ...
            if (cVar2 == '\0') {
              ...
              if (pcVar17 == (char *)0x0) {
                piVar13 = (int *)func_0x001032a0();
                iVar3 = *piVar13;
                if ((uVar11 != 2) || (iVar3 == 0xc)) goto code_r0x0010c8b0;
              }
              else {
                lVar5 = func_0x00103400(pcVar17);
                lVar6 = func_0x00103400(pcVar14);
                uVar4 = lVar5 + 1 + lVar6;
                if (uStack232 == 0) {
                  uStack232 = 0x1000;
                  if (0xfff < uVar4) {
                ...
                func_0x00103750(pcStack240 + lVar5,pcVar14,lVar6 + 1);
                func_0x001035f0(pcStack240,pcVar17,lVar5);
...
code_r0x0010c8b0:
                func_0x00103880(pcStack240);
                func_0x00103880(pcVar10);
                pcVar17 = pcStack264;
                goto code_r0x0010c8ca;
              }
            }
          }
          else {
            if ((uStack192 & 0xf000) != 0x4000) goto code_r0x0010c6ee;
          }
        }
code_r0x0010c700:
        cVar2 = *pcVar14;
        pcVar17 = pcStack264;
        goto joined_r0x0010c601;
      }
    }
  }
  else {
