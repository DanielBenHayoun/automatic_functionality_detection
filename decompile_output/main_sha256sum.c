...
ulong sha256sum(uint param_1,undefined8 *param_2)

{
  ...
  func_0x00101800(6,&UNK_0010a341);
  func_0x00101650(&UNK_00109236,&UNK_0010925f);
  func_0x00101630(&UNK_00109236);
  atexit(close_stdout);
  ...
  do {
    while( true ) {
      ...
      *(undefined8 *)(puVar17 + -8) = 0x1019b4;
      iVar5 = func_0x001016a0(puVar23,param_2,&UNK_001092a0,long_options);
      if (iVar5 == -1) {
    ...
    if (iVar5 == 0x62) {
      ...
      if (iVar5 < 99) {
        if (iVar5 == -0x83) {
          ...
          *(undefined8 *)(puVar17 + -0x10) = 0x109293;
          *(undefined8 *)(puVar17 + -0x18) = 0x101a96;
          version_etc(stdout,&UNK_001091aa,&UNK_00109232,Version);
...
code_r0x00101bda:
          unaff_R15 = uVar13;
          if (((puVar17[0x2b] == '\0') || (puVar19 = &UNK_001099e8, puVar17[0x78] == '\0')) &&
             (((int)pbVar18 < 0 || (puVar19 = &UNK_00109a28, puVar17[0x2b] == '\0')))) {
            if (ignore_missing == '\0') goto code_r0x001029e8;
            if (puVar17[0x2b] == '\0') {
code_r0x00102a2c:
              puVar19 = &UNK_00109a78;
            }
            else {
...
code_r0x001027fd:
                  ...
                  do {
                    ...
                    *(undefined8 *)(puVar17 + -8) = 0x1024cc;
                    func_0x00101810(1,&UNK_00109317,(ulong)bVar4);
...
code_r0x00102533:
                ...
                *(int *)(puVar17 + 0x2c) = (int)cVar3;
                if (cVar3 == '\0') {
                  ...
                  *(undefined8 *)(puVar17 + -8) = 0x101d04;
                  uVar7 = func_0x00101660(0,&UNK_001092a6,5);
                  *(undefined8 *)(puVar17 + 0x20) = uVar7;
                  puVar23 = stdin;
                }
                else {
                  *(undefined8 *)(puVar17 + -8) = 0x102426;
                  puVar23 = (uint *)fopen_safer(*(undefined8 *)(puVar17 + 0x20),&UNK_00109282);
                ...
                *(undefined **)(puVar17 + 0x38) = puVar17 + 0xd0;
                do {
...
code_r0x00101e44:
                  ...
                  if (warn != '\0') {
                    ...
                    *(undefined8 *)(puVar17 + -8) = 0x1021f7;
                    uVar8 = func_0x00101660(0,&UNK_00109bc0,5);
...
code_r0x00102432:
                          ...
                          *(undefined8 *)(puVar17 + -8) = 0x102460;
                          func_0x00101830(0,(ulong)uVar1,&UNK_00109d75,param_2);
                          bVar4 = 0;
                      ...
                      if (puVar17[0x30] == '\0') {
                        ...
                        *(undefined8 *)(puVar17 + -8) = 0x10266c;
                        uVar7 = func_0x00101660(0,&UNK_00109bf0,5);
                        pbVar22 = &UNK_001091b4;
                        ...
                        if (status_only == '\0') {
                          if (unaff_R13 != 0) {
                            ...
                            *(undefined8 *)(puVar17 + -8) = 0x1020fc;
                            uVar7 = func_0x00101860(0,&UNK_00109c58,&UNK_00109c28,unaff_R13);
                          ...
                          if (*(long *)(puVar17 + 0x50) != 0) {
                            ...
                            *(undefined8 *)(puVar17 + -8) = 0x102138;
                            uVar7 = func_0x00101860(0,&UNK_00109cb8,&UNK_00109c88,uVar13);
                          ...
                          if (*(long *)(puVar17 + 0x58) != 0) {
                            ...
                            *(undefined8 *)(puVar17 + -8) = 0x102174;
                            uVar7 = func_0x00101860(0,&UNK_00109d18,&UNK_00109ce8,uVar13);
                          ...
                          if (puVar17[0x7a] == '\0') {
                            ...
                            *(undefined8 *)(puVar17 + -8) = 0x10291e;
                            uVar7 = func_0x00101660(0,&UNK_001092fe,5);
...
code_r0x001021be:
                      ...
                      *(undefined8 *)(puVar17 + -8) = 0x102595;
                      uVar7 = func_0x00101660(0,&UNK_001092ef,5);
...
code_r0x00102383:
                    if (have_read_stdin != '\0') {
                      ...
                      *(undefined8 *)(puVar17 + -8) = 0x102728;
                      pbVar16 = (byte *)func_0x00101660(0,&UNK_001092a6,5);
...
code_r0x0010232d:
                                puVar19 = &UNK_001092e5;
                                goto code_r0x0010206b;
                              }
                            }
                            if (quiet == '\0') {
                              puVar19 = &UNK_001092ec;
                              goto code_r0x0010206b;
                            }
                          }
                        }
...
code_r0x00102390:
                    if (*(long *)(puVar17 + 0xf8) == *(long *)(in_FS_OFFSET + 0x28)) {
...
code_r0x00101e60:
                ...
                *(undefined8 *)(puVar17 + -8) = 0x101e91;
                uVar7 = func_0x00101660(0,&UNK_001092b5,5);
                *(undefined8 *)(puVar17 + -8) = 0x101ea5;
                func_0x00101830(1,0,uVar7,param_2);
code_r0x00101ea5:
                unaff_R15 = uVar13;
                if ((quiet == '\x01') && (puVar19 = &UNK_00109b40, puVar17[0x2b] == '\0')) break;
code_r0x00101ec5:
                uVar13 = unaff_R15;
              } while ((strict == 0) || (puVar19 = &UNK_00109b80, puVar17[0x2b] != '\0'));
            }
          }
code_r0x00101bbb:
