...

{
  ...
  uVar17 = param_5;
  if (0x24 < param_3) goto code_r0x001076f5;
  unaff_R15 = param_2;
  if (param_2 == (byte **)0x0) {
    unaff_R15 = &pbStack72;
  }
  piVar4 = (int *)func_0x00101b20();
  *piVar4 = 0;
  bVar1 = *param_1;
  plVar5 = (long *)func_0x00101f50();
  pbVar6 = param_1;
  while ((*(byte *)(*plVar5 + 1 + (ulong)bVar1 * 2) & 0x20) != 0) {
    pbVar6 = pbVar6 + 1;
    bVar1 = *pbVar6;
  }
  if (bVar1 == 0x2d) goto code_r0x00107448;
  uVar7 = func_0x00101ca0(param_1,unaff_R15,(ulong)param_3,0);
  puVar11 = *unaff_R15;
  if (puVar11 == param_1) {
...
code_r0x00107448:
    ...
    unaff_RBP = 0;
    lVar8 = func_0x00101c60(param_5,(ulong)(uint)(int)(char)bVar1);
    uVar7 = 1;
    if (lVar8 == 0) goto code_r0x00107448;
  }
  else {
    if (*piVar4 == 0) {
      unaff_RBP = 0;
      ...
      unaff_RBP = 1;
      if (*piVar4 != 0x22) goto code_r0x00107448;
    }
  ...
  if (lVar8 == 0) goto code_r0x0010758c;
  if ((((byte)((uint)bVar1 - 0x45) < 0x30) &&
      ((0x814400308945U >> ((ulong)((uint)bVar1 - 0x45) & 0x1f) & 1) != 0)) &&
     (lVar8 = func_0x00101c60(param_5,0x30), lVar8 != 0)) {
    bVar2 = puVar11[1];
    if (bVar2 != 0x44) {
      if (bVar2 == 0x69) {
      ...
      if (bVar2 != 0x42) goto code_r0x00107520;
    }
...
code_r0x0010758c:
  ...
  case 0x6b:
    ...
    if (SUB168(auVar3 * ZEXT816(puVar13) >> 0x40,0) == 0) goto code_r0x00107570;
    break;
  case 0x4d:
  case 0x6d:
...
code_r0x00107557:
  ...
  case 0x50:
    ...
    do {
      ...
      uVar16 = (int)uVar17 - 1;
      uVar17 = (ulong)uVar16;
      if (uVar16 == 0) goto code_r0x001075e5;
    } while( true );
  case 0x54:
  case 0x74:
    uVar17 = 4;
...
code_r0x001076f5:
  ...
  puVar13 = &UNK_001173cf;
  puVar15 = &UNK_001173e0;
