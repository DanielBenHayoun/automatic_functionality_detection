...

{
  ...
  if (1 < *(int *)(param_1 + 0x90)) {
    ...
    lVar1 = func_0x00101b30(*(undefined8 *)(param_1 + 0x10),param_2 * 4);
    if (lVar1 == 0) {
      return 0xc;
    }
    *(long *)(param_1 + 0x10) = lVar1;
    if (*(long *)(param_1 + 0x18) != 0) {
      lVar1 = func_0x00101b30(*(long *)(param_1 + 0x18),param_2 * 8);
      if (lVar1 == 0) {
        return 0xc;
      }
  ...
  if (*(char *)(param_1 + 0x8b) != '\0') {
    lVar1 = func_0x00101b30(*(undefined8 *)(param_1 + 8),param_2);
    if (lVar1 == 0) {
      return 0xc;
    }
