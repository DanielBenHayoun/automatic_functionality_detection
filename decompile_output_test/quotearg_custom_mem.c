...
void quotearg_custom_mem(undefined *param_1,long param_2,undefined *param_3)
  ...
  do {
    ...
    *(int *)(puVar2 + -0x1c) = SUB164(default_quoting_options._32_16_ >> 0x60,0);
    if ((param_1 == (undefined *)0x0) || (param_2 == 0)) {
      *(undefined8 *)(puVar2 + -0x50) = 0x10a45c;
      ...
      *(undefined8 *)(puVar2 + -0x50) = 0x10a442;
    ...
    *(undefined8 *)(puVar2 + -0x50) = 0x10a461;
    func_0x001021f0();
    param_3 = puVar1;
