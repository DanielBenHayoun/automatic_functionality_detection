...

{
  ...
  if ((param_1 & 0x102) == 0) {
    ...
    if ((lVar12 != 0) && (-1 < *(long *)(lVar12 + 0x58))) {
      plVar20 = *param_2;
      if (plVar20[2] == 0) goto code_r0x00107653;
...
code_r0x00107653:
  ...
  if (lVar1 == 0) {
    ...
    *(long *)(lVar12 + 0x18) = lVar13;
    if (lVar13 == 0) goto joined_r0x00107e35;
    if (*(short *)(lVar12 + 0x70) == 0xb) {
      ...
      *(undefined2 *)(lVar12 + 0x70) = uVar6;
      ...
      if ((*(uint *)(plVar19 + 9) & 0x100) != 0) {
        ...
        if (cVar5 == '\0') {
          puVar14 = (undefined4 *)func_0x001019c0();
          lStack192 = 0;
          *puVar14 = 0xc;
          goto code_r0x00107c25;
        }
      }
    }
...
code_r0x00107ea0:
    ...
    uStack108 = func_0x00101bd0();
    if ((int)uStack108 < 0) {
      func_0x00101b90(*(undefined8 *)(lVar12 + 0x18));
      *(undefined8 *)(lVar12 + 0x18) = 0;
joined_r0x00107e35:
      if (iVar17 == 3) {
...
code_r0x0010782f:
  do {
    ...
    if (unaff_R13 == 0) goto joined_r0x00107d10;
    piVar9 = (int *)func_0x001019c0();
    *piVar9 = 0;
    puVar10 = (undefined8 *)func_0x00101c30(unaff_R13);
...
code_r0x00107cb0:
    ...
    *piVar9 = iVar7;
    ...
    if (uStack168 <= uVar11) {
      ...
      if (cVar5 == '\0') goto code_r0x00107cb0;
      puVar4 = puStack144;
      ...
      *(undefined8 *)(unaff_R13 + 0x80) = *puVar10;
      ...
      if ((uVar18 & 4) == 0) {
        ...
        *(undefined8 *)(unaff_R13 + 0x30) = *(undefined8 *)(unaff_R13 + 0x38);
        func_0x00101ce0(puStack144,unaff_R13 + 0x108,*(long *)(unaff_R13 + 0x60) + 1);
        uVar18 = *(uint *)(plVar19 + 9);
      }
  ...
  *(undefined8 *)(unaff_R13 + 0x10) = 0;
  ...
  if ((uVar11 == 10000) && (plVar19[8] == 0)) {
    ...
    if ((lVar12 == 0x1021994) || ((lVar12 == 0xff534d42 || (lVar12 == 0x6969)))) {
      cStack114 = '\0';
      goto code_r0x0010781b;
    }
    uVar16 = 0x2711;
    cStack114 = '\x01';
    lVar13 = unaff_R13;
    if (0x2711 < uStack152) goto code_r0x0010782f;
  }
  else {
code_r0x0010781b:
    uVar16 = uVar11 + 1;
    lVar13 = unaff_R13;
    if (uVar16 < uStack152) goto code_r0x0010782f;
  }
  uVar16 = uVar11 + 1;
joined_r0x00107d10:
  if (cStack115 != '\0') {
  ...
  if ((lVar1 == 0) && (cStack113 != '\0')) {
    if ((iVar17 == 1) || (uVar16 == 0)) {
      if (*(long *)(lStack176 + 0x58) == 0) {
        ...
        iVar7 = fts_safe_changedir(plVar19,*(undefined8 *)(lStack176 + 8),0xffffffff,&UNK_0010c4a1);
      }
      if (iVar7 == 0) goto code_r0x00107db0;
      *(undefined2 *)(lStack176 + 0x70) = 7;
      *(uint *)(plVar19 + 9) = *(uint *)(plVar19 + 9) | 0x2000;
      fts_lfree(lStack192);
      lStack192 = 0;
...
code_r0x00107db0:
    if (uVar16 != 0) goto code_r0x00107d56;
