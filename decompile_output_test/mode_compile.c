...
code_r0x00102ff2:
    ...
    if (bVar1 == 0x61) {
      ...
      if (bVar1 == 0x6f) {
        ...
        if (bVar1 == 0x75) {
          ...
          if (bVar1 != 0x67) goto code_r0x00103023;
          uVar12 = uVar12 | 0x438;
        }
      }
    }
  ...
  if (((bVar1 != 0x2d) && (bVar1 != 0x3d)) && (bVar1 != 0x2b)) goto code_r0x00103023;
...
code_r0x001030c3:
      ...
      if ('g' < (char)bVar1) {
        if (bVar1 == 0x6f) {
          ...
          uVar10 = 0x1c0;
          if (bVar1 != 0x75) goto code_r0x00103180;
        }
        goto code_r0x001030ac;
      }
      if (7 < (byte)(bVar1 - 0x30)) {
code_r0x00103180:
        uVar10 = 0;
        if ((byte)(bVar1 + 0xa8) < 0x21) {
                    /* WARNING: Could not recover jumptable at 0x001031a4. Too many branches */
        ...
        *(undefined4 *)(puVar8 + 8) = 0;
        goto code_r0x001030c3;
      }
      uVar10 = 0;
      do {
        uVar10 = (uVar7 - 0x30) + uVar10 * 8;
        param_1 = param_1 + 1;
        if (0xfff < uVar10) goto code_r0x00103023;
        bVar1 = *param_1;
        uVar7 = SEXT14((char)bVar1);
      } while ((byte)(bVar1 - 0x30) < 8);
      if ((uVar12 != 0) || ((bVar1 != 0 && (bVar1 != 0x2c)))) goto code_r0x00103023;
      *puVar8 = uVar11;
      puVar8[1] = 1;
      uVar2 = (ulong)uVar7;
...
code_r0x00103023:
      func_0x00101a90(lVar3);
      lVar3 = 0;
    }
    return (undefined2 *)lVar3;
  }
  param_1 = param_1 + 1;
  goto code_r0x00102ff2;
}
