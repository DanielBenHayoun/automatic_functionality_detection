...

{
  ...
  uVar17 = param_5;
  if (0x24 < param_3) goto code_r0x00105895;
  unaff_R15 = param_2;
  if (param_2 == (byte **)0x0) {
    unaff_R15 = &pbStack72;
  }
  piVar4 = (int *)func_0x00101710();
  *piVar4 = 0;
  bVar1 = *param_1;
  ...
  uVar7 = func_0x001019f0(param_1,unaff_R15);
  puVar11 = *unaff_R15;
  if (puVar11 == param_1) {
...
code_r0x001055e8:
    ...
    unaff_RBP = 0;
    lVar8 = func_0x00101810(param_5,(ulong)(uint)(int)(char)bVar1);
    uVar7 = 1;
    if (lVar8 == 0) goto code_r0x001055e8;
  }
  else {
    if (*piVar4 == 0) {
      unaff_RBP = 0;
      ...
      unaff_RBP = 1;
      if (*piVar4 != 0x22) goto code_r0x001055e8;
    }
  ...
  if (lVar8 == 0) goto code_r0x0010572c;
  if ((((byte)((uint)bVar1 - 0x45) < 0x30) &&
      ((0x814400308945U >> ((ulong)((uint)bVar1 - 0x45) & 0x1f) & 1) != 0)) &&
     (lVar8 = func_0x00101810(param_5,0x30), lVar8 != 0)) {
    bVar2 = puVar11[1];
    if (bVar2 != 0x44) {
      if (bVar2 == 0x69) {
