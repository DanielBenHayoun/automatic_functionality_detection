...

{
  ...
  lVar7 = param_3;
  iVar2 = nstrftime(param_3,100,&UNK_00113072,param_1,0,0);
  if (((param_2 != 0) && (iVar2 < 100)) && (*(long *)(param_2 + 0xd0) != 0)) {
    ...
    func_0x00102740(lVar7,puVar6,1,0xffffffffffffffff,&UNK_0011308c,uVar4);
  }
  ...
  if (*(char *)(lVar7 + 0xe0) == '\0') {
    *puVar6 = 0;
    ...
    if (uVar5 < 0xe) {
      uVar3 = func_0x00102890(puVar6,100,&UNK_00112de0,ordinal_values_5108 + uVar5 * 0xb);
    }
    else {
      uVar3 = func_0x00102740(puVar6,100,1,0xffffffffffffffff,&UNK_00113100);
    }
    uVar1 = *(uint *)(lVar7 + 0x10);
...
code_r0x00106821:
      func_0x00102740(puVar8,lVar7,1,0xffffffffffffffff,&UNK_00112ddf + uVar5,
