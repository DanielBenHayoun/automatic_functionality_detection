...

{
  ...
  plVar2 = (long *)func_0x001023c0(0x50);
  if (plVar2 == (long *)0x0) {
    return (long *)0;
  }
  if (param_2 == 0) {
    ...
    if (cVar1 == '\0') goto code_r0x00106a30;
    fVar6 = _UNK_00110018;
    if ((long)param_1 < 0) goto code_r0x00106abb;
code_r0x00106a71:
    fVar5 = (float)param_1;
code_r0x00106a7a:
    fVar5 = fVar5 / fVar6;
    if (_UNK_0011001c <= fVar5) goto code_r0x00106a30;
    if (fVar5 < _UNK_00110020) {
      param_1 = (ulong)fVar5;
    }
    else {
      param_1 = (long)(fVar5 - _UNK_00110020) ^ 0x8000000000000000;
    }
  }
  else {
    plVar2[5] = param_2;
