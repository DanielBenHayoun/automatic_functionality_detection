    ...
    *(byte *)((long)pplStack96 + 0x32) = *(byte *)((long)pplStack96 + 0x32) | 4;
    if ((long **)param_1[1] == (long **)0x0) {
      ...
      while ((pplStack104 = param_1, param_1 = (long **)pplStack104[2], param_1 == (long **)0x0 ||
        ...
        if ((long **)*pplStack104 == (long **)0x0) goto code_r0x0010825c;
      }
...
code_r0x0010841d:
  ...
  if (lStack208 != *(long *)(in_FS_OFFSET + 0x28)) {
    ...
    *pplVar10 = plVar8;
    plVar8 = (long *)func_0x00101ac0((long)plVar8 * 8);
    pplVar10[2] = plVar8;
    if (plVar8 == (long *)0x0) {
      pplVar10[1] = (long *)0x0;
      *pplVar10 = (long *)0x0;
      ...
      func_0x00101a90(plVar8,pplVar12[2],(long)plVar1 * 8);
      uVar9 = 0;
    }
    return (long **)uVar9;
  }
