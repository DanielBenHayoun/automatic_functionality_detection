...

{
  ...
  puVar9 = &UNK_00109bf1;
  puVar5 = (undefined4 *)func_0x001020b0(0,param_1,param_2);
  uVar1 = *puVar5;
  puVar7 = slotvec;
  if (nslots < 1) {
  ...
  uVar6 = quotearg_buffer_restyled
                    (puVar8,uVar2,param_1,param_2,(ulong)default_quoting_options._0_4_,(ulong)uVar4,
                     0x314548,default_quoting_options._40_8_,default_quoting_options._48_8_,puVar9);
  if (uVar2 <= uVar6) {
    uVar6 = uVar6 + 1;
    *puVar7 = uVar6;
    if (puVar8 != slot0) {
    ...
    *(undefined1 **)(puVar7 + 1) = puVar8;
    quotearg_buffer_restyled
              (puVar8,uVar6,param_1,param_2,(ulong)default_quoting_options._0_4_,(ulong)uVar4,
               0x314548,default_quoting_options._40_8_,default_quoting_options._48_8_,puVar9);
  }
  *puVar5 = uVar1;
  return puVar8;
