...
code_r0x0010a6cd:
  ...
  if (0 < (long)plVar1) {
    *pplVar11 = plVar7;
    plVar7 = (long *)func_0x00101da0((long)plVar7 * 8);
    pplVar11[2] = plVar7;
    if (plVar7 == (long *)0x0) {
      pplVar11[1] = (long *)0x0;
      *pplVar11 = (long *)0x0;
      ...
      func_0x00101d70(plVar7,pplVar10[2],(long)plVar1 * 8);
      uVar8 = 0;
    }
    return uVar8;
  }
