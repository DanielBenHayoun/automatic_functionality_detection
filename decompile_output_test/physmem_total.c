...

{
  ...
  pcStack160 = (code *)&UNK_00103d84;
  lVar3 = func_0x00101d10(0x55);
  dStack144 = (double)lVar3;
  pcStack160 = (code *)&UNK_00103d9d;
  lVar3 = func_0x00101d10(dStack144,0x1e);
  if ((dStack144 < 0.00000000) || (dVar15 = (double)lVar3, dVar14 = dStack144, dVar15 < 0.00000000))
  {
    pcStack160 = (code *)&UNK_00103dea;
    iVar2 = func_0x00101d30(dStack144,auStack136);
    dVar14 = _UNK_001078a0;
    if (iVar2 == 0) {
      if ((long)uStack104 < 0) {
        dVar14 = (double)(uStack104 >> 1 | (ulong)((uint)uStack104 & 1));
        dVar14 = dVar14 + dVar14;
      }
      else {
        dVar14 = (double)uStack104;
      }
      dVar15 = (double)(ulong)uStack32;
      goto code_r0x00103dbc;
    }
  }
  else {
code_r0x00103dbc:
  ...
  if ((dVar14 < 0.00000000) || (dVar15 = (double)lVar3, dVar15 < 0.00000000)) {
    ...
    if ((long)uStack248 < 0) {
      dVar14 = (double)(uStack248 >> 1 | (ulong)((uint)uStack248 & 1));
      dVar14 = dVar14 + dVar14;
    }
    else {
      dVar14 = (double)uStack248;
    }
    if ((long)uStack232 < 0) {
      dVar15 = (double)(uStack232 >> 1 | (ulong)((uint)uStack232 & 1));
      dVar15 = dVar15 + dVar15;
    }
    else {
      dVar15 = (double)uStack232;
    }
    dVar14 = dVar14 + dVar15;
    dVar15 = (double)(ulong)uStack184;
  }
  dVar14 = dVar14 * dVar15;
code_r0x00103ea0:
