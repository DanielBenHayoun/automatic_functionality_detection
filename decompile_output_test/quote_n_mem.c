...
undefined1 * quote_n_mem(undefined1 *param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if (-1 < iVar10) {
    ...
    uVar6 = quotearg_buffer_restyled
                      (puVar12,uVar2,param_2,param_3,(ulong)quote_quoting_options._0_4_,(ulong)uVar4
                       ,0x314288,quote_quoting_options._40_8_,quote_quoting_options._48_8_,puVar13);
    if (uVar2 <= uVar6) {
      uVar6 = uVar6 + 1;
      *puVar9 = uVar6;
      if (puVar12 != slot0) {
      ...
      *(undefined1 **)(puVar9 + 1) = puVar12;
      quotearg_buffer_restyled
                (puVar12,uVar6,param_2,param_3,(ulong)quote_quoting_options._0_4_,(ulong)uVar4,
                 0x314288,quote_quoting_options._40_8_,quote_quoting_options._48_8_,puVar13);
    }
    *puVar5 = uVar1;
    return puVar12;
