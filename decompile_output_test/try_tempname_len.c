...
ulong try_tempname_len(long param_1,int param_2,undefined8 param_3,code *param_4,ulong param_5)

{
  ...
  if ((long)param_2 + param_5 <= uVar4) {
    lVar8 = (uVar4 - param_5) - (long)param_2;
          ...
          if (param_5 != 0) {
            do {
              ...
              *puVar10 = letters[lVar6];
              puVar10 = puVar11;
            } while (puVar11 != (undefined *)(lVar8 + param_1 + param_5));
          }
