...

{
  ...
  if ((uVar4 != 0xffffffff) || (piVar5 = (int *)func_0x00101640(), *piVar5 != 0xc)) {
    return uStack56;
  }
  xalloc_die();
  lStack72 = *(long *)(in_FS_OFFSET + 0x28);
  uVar17 = param_5;
  if (0x24 < extraout_EDX) goto code_r0x00105b85;
  unaff_R15 = param_2;
  if (param_2 == (byte **)0x0) {
    unaff_R15 = &pbStack80;
  }
  piVar5 = (int *)func_0x00101640();
  *piVar5 = 0;
  bVar1 = *param_1;
  plVar6 = (long *)func_0x00101970();
  pbVar7 = param_1;
  while ((*(byte *)(*plVar6 + 1 + (ulong)bVar1 * 2) & 0x20) != 0) {
    pbVar7 = pbVar7 + 1;
    bVar1 = *pbVar7;
  }
  if (bVar1 == 0x2d) goto code_r0x001058d8;
  uVar8 = func_0x00101900(param_1,unaff_R15);
  puVar12 = *unaff_R15;
  if (puVar12 == param_1) {
    if ((param_5 == 0) || (bVar1 = *param_1, bVar1 == 0)) {
code_r0x001058d8:
      unaff_RBP = 4;
      goto code_r0x001058dd;
    }
    unaff_RBP = 0;
    lVar9 = func_0x00101730(param_5,(ulong)(uint)(int)(char)bVar1);
    uVar8 = 1;
    if (lVar9 == 0) goto code_r0x001058d8;
  }
  else {
    if (*piVar5 == 0) {
      unaff_RBP = 0;
      ...
      unaff_RBP = 1;
      if (*piVar5 != 0x22) goto code_r0x001058d8;
    }
...
code_r0x00105a1c:
  ...
  case 0x67:
    ...
    goto code_r0x001059e7;
  case 0x4b:
  case 0x6b:
    auVar3 = ZEXT816(uVar8);
    uVar8 = SUB168(auVar3 * ZEXT816(puVar13),0);
    if (SUB168(auVar3 * ZEXT816(puVar13) >> 0x40,0) == 0) goto code_r0x00105a00;
    break;
  case 0x4d:
  case 0x6d:
...
code_r0x001059e7:
  ...
  case 0x50:
    ...
    do {
      ...
      uVar16 = (int)uVar17 - 1;
      uVar17 = (ulong)uVar16;
      if (uVar16 == 0) goto code_r0x00105a75;
    } while( true );
  case 0x54:
  case 0x74:
    uVar17 = 4;
...
code_r0x00105b85:
  ...
  puVar13 = &UNK_00107240;
  puVar15 = &UNK_00107250;
  func_0x00101780(&UNK_00107250,&UNK_00107240,0x54);
  do {
    uVar18 = 1;
    uVar8 = 0xffffffffffffffff;
    do {
