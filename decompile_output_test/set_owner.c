...

{
  ...
  if (param_5 == '\0') {
    if ((*(ulong *)(param_1 + 0x18) & 0xff0000000000ff) == 0) {
      if (*(char *)(param_1 + 0x2b) == '\0') goto code_r0x00105895;
    ...
    if (((((uint)CONCAT11((char)((ulong)~uVar9 >> 8),(char)~uVar9) | 0xe00) & uVar11 & 0xfff) != 0)
      ...
      puVar6 = (uint *)func_0x00102770();
      if (((*puVar6 != 1) && (*puVar6 != 0x16)) || (*(char *)(param_1 + 0x1b) != '\0')) {
        uVar7 = quotearg_style(4,param_2);
        uVar8 = func_0x001028e0(0,&UNK_00114dfb,5);
        func_0x00102cb0(0,(ulong)*puVar6,uVar8,uVar7);
      }
      goto code_r0x00105a0c;
    }
  }
code_r0x00105895:
  if (param_3 == 0xffffffff) {
    iVar4 = func_0x00102c00(param_2,(ulong)uVar1,(ulong)uVar2);
    if (iVar4 == 0) {
      return 1;
    }
    piVar5 = (int *)func_0x00102770();
    iVar4 = *piVar5;
    if ((iVar4 == 1) || (iVar4 == 0x16)) {
      func_0x00102c00(param_2,0xffffffff,(ulong)uVar2);
      *piVar5 = iVar4;
    }
  }
  else {
    iVar4 = func_0x00102cf0(uVar10);
    if (iVar4 == 0) {
      return 1;
    }
    piVar5 = (int *)func_0x00102770();
    iVar4 = *piVar5;
    if ((iVar4 == 1) || (iVar4 == 0x16)) {
      func_0x00102cf0(uVar10,0xffffffff,(ulong)uVar2);
      *piVar5 = iVar4;
    }
  }
  ...
  uVar7 = quotearg_style(4,param_2);
  uVar8 = func_0x001028e0(0,&UNK_001130f8,5);
  puVar6 = (uint *)func_0x00102770();
  func_0x00102cb0(0,(ulong)*puVar6,uVar8,uVar7);
code_r0x00105a0c:
