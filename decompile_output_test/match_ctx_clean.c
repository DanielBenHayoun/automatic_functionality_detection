    ...
    do {
      ...
      if (0 < *(long *)(lVar1 + 0x20)) {
        ...
        do {
          ...
          lVar3 = lVar3 + 1;
          func_0x00101b00(*(undefined8 *)(lVar2 + 0x20));
          func_0x00101b00(lVar2);
        } while (*(long *)(lVar1 + 0x20) != lVar3 && lVar3 <= *(long *)(lVar1 + 0x20));
      }
      func_0x00101b00(*(undefined8 *)(lVar1 + 0x28));
      if (*(long *)(lVar1 + 0x10) != 0) {
        func_0x00101b00(*(undefined8 *)(*(long *)(lVar1 + 0x10) + 0x10));
        func_0x00101b00(*(undefined8 *)(lVar1 + 0x10));
      }
      lVar4 = lVar4 + 1;
      func_0x00101b00(lVar1);
