...
undefined8 base64(uint param_1,undefined8 ****param_2)

{
  ...
  func_0x00101720(6,&UNK_00106801);
  func_0x00101560(&UNK_00105c43,&UNK_00105c6c);
  func_0x00101540(&UNK_00105c43);
  atexit(close_stdout);
  uStack120 = (undefined8 ****)((ulong)uStack120 & 0xffffffffffffff00);
  while( true ) {
    puVar8 = long_options;
    iVar3 = func_0x001015b0(ppppuVar16,param_2,&UNK_00105ca6,long_options,0);
    if (iVar3 == -1) break;
    if (iVar3 == 100) {
      cVar9 = '\x01';
    }
      ...
      if (iVar3 < 0x65) {
        ...
        version_etc(stdout,&UNK_00105ba4,&UNK_00105c3f,Version,&UNK_00105c96,0);
        func_0x00101790(0);
        break;
      }
      if (iVar3 == 0x69) {
...
code_r0x00101fb7:
            ...
            if (iVar3 == -1) {
              uVar7 = func_0x00101570(0,&UNK_00105cca,5);
...
code_r0x00101c9b:
            if ((uVar4 & 0x20) != 0) {
              ppppuVar10 = (undefined8 ****)func_0x00101570(0,&UNK_00105cbf,5);
              puVar5 = (uint *)func_0x001014f0();
              func_0x00101750(1,(ulong)*puVar5,ppppuVar10);
              do {
                ppppuVar12 = (undefined8 ****)((((long)ppppuVar13 + 2U) / 3) * 4);
                base64_encode(ppppuVar16,ppppuVar13,ppppuStack152,ppppuVar12);
                if (ppppuStack160 == (undefined8 ****)0x0) {
                  ...
                  if (ppppuVar14 <= ppppuVar12 &&
                    ...
                    ppppuVar11 = (undefined8 ****)func_0x00101570(0,&UNK_00105cca,5);
                    puVar5 = (uint *)func_0x001014f0();
...
code_r0x00101bc2:
            ...
            if (iVar3 == -1) {
code_r0x00101e55:
              uVar4 = func_0x00101690(pppuStack96,&UNK_001062ca);
              ppppuVar13 = (undefined8 ****)(ulong)uVar4;
              puVar5 = (uint *)func_0x001014f0();
              if (uVar4 == 0) {
                uVar7 = func_0x00101570(0,&UNK_00105ce4,5);
                func_0x00101750(1,(ulong)*puVar5,uVar7);
              }
              puVar8 = (undefined1 *)quotearg_n_style_colon(0,3,pppuStack96);
              func_0x00101750(1,(ulong)*puVar5,&UNK_00106284);
code_r0x00101ec1:
              uVar7 = func_0x00101570(0,&UNK_00105cd6,5);
...
code_r0x00101f11:
              uVar7 = func_0x00101570(0,&UNK_00105cbf,5);
              puVar5 = (uint *)func_0x001014f0();
              func_0x00101750(1,(ulong)*puVar5,uVar7);
              param_2 = ppppuVar14;
...
code_r0x00101f7c:
              ...
              uVar7 = func_0x00101570(0,&UNK_00105cab,5);
              func_0x00101750(0,0,uVar7);
            }
          } while( true );
        }
        func_0x00101570(0,&UNK_00105c84,5);
        ppppuVar12 = (undefined8 ****)xdectoumax(optarg,0,0xffffffffffffffff,&UNK_00106801);
      }
    }
  }
  lVar6 = (long)optind;
  ...
  if (optind < (int)param_1) {
    ...
    iVar3 = func_0x00101690(pppuStack96,&UNK_001062ca);
    param_2 = stdin;
    if ((iVar3 == 0) ||
       (param_2 = (undefined8 ****)func_0x00101770(pppuStack96,&UNK_00105cbc),
       param_2 != (undefined8 ****)0x0)) goto code_r0x001019e2;
    uVar7 = quotearg_n_style_colon(0,3,pppuStack96);
    cVar9 = (char)uVar7;
    puVar5 = (uint *)func_0x001014f0();
    func_0x00101750(1,(ulong)*puVar5,&UNK_00106284,uVar7);
  }
  pppuStack96 = (undefined8 ***)&UNK_001062ca;
  param_2 = stdin;
code_r0x001019e2:
  fadvise(param_2,2);
  if (cVar9 == '\0') {
    ...
    ppppuStack152 = (undefined8 ****)xmalloc(0xa000);
    ppppuStack160 = ppppuVar12;
    goto code_r0x00101c26;
  }
  ppppuStack112 = stdout;
  ppppuVar13 = (undefined8 ****)xmalloc(0x1000);
  ppppuStack104 = (undefined8 ****)xmalloc(0xc00);
  ppppuStack144 = (undefined8 ****)aiStack72;
  base64_decode_ctx_init(ppppuStack144);
  ppppuStack136 = &ppppuStack80;
...
code_r0x00101a48:
  ...
  do {
    ...
    ppppuVar14 = (undefined8 ****)
                 func_0x00101530((long)ppppuStack160 + (long)ppppuVar10,1,0x1000 - (long)ppppuVar10,
                                 ppppuStack152);
    ppppuStack80 = ppppuVar14;
    if ((char)uStack120 != '\0') {
...
code_r0x00101a50:
  ...
  } while ((ppppuVar10 < (undefined8 ****)0x1000) && ((uVar4 & 0x10) == 0));
  unaff_R14 = (char *)0x0;
  ...
  do {
    ...
    if ((uVar4 & 0x10) == 0) {
      ...
      if (uVar17 == 1) {
        if (aiStack72[0] == 0) goto code_r0x00101bc2;
        ppppuVar12 = (undefined8 ****)0x0;
      }
    }
    ppppuStack80 = (undefined8 ****)0xc00;
    uVar4 = base64_decode_ctx(ppppuStack144,ppppuVar13,ppppuVar12,ppppuVar15,ppppuStack136);
    ppppuVar16 = (undefined8 ****)(ulong)uVar4;
    puVar8 = (undefined1 *)ppppuVar11;
    ppppuVar12 = (undefined8 ****)func_0x00101700(ppppuVar15,1,ppppuStack80,ppppuVar11);
    if (ppppuVar12 < ppppuStack80) goto code_r0x00101ee5;
