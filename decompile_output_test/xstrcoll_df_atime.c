...
ulong xstrcoll_df_atime(undefined8 *param_1,undefined8 *param_2)

{
  ...
  if ((*(int *)(param_1 + 0x15) == 3) || (*(int *)(param_1 + 0x15) == 9)) {
    if (iVar1 == 3 || iVar1 == 9) goto code_r0x0010af58;
...
code_r0x0010af58:
  ...
  if (lVar2 <= lVar3) {
    uVar7 = (int)param_2[0xd] - *(int *)(param_1 + 0xd);
    if (uVar7 == 0) {
      uVar5 = *param_2;
      uVar4 = *param_1;
