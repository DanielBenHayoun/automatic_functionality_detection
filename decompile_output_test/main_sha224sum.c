...
ulong sha224sum(uint param_1,undefined8 *param_2)

{
  ...
  func_0x00101650(&UNK_00109234,&UNK_0010925d);
  func_0x00101630(&UNK_00109234);
  atexit(close_stdout);
  ...
  do {
    while( true ) {
      ...
      *(undefined8 *)(puVar17 + -8) = 0x1019b4;
      iVar5 = func_0x001016a0(puVar23,param_2,&UNK_0010929e,long_options);
      if (iVar5 == -1) {
    ...
    if (iVar5 == 0x62) {
      ...
      if (iVar5 < 99) {
        if (iVar5 == -0x83) {
          ...
          *(undefined8 *)(puVar17 + -0x10) = 0x109291;
          *(undefined8 *)(puVar17 + -0x18) = 0x101a96;
          version_etc(stdout,&UNK_001091aa,&UNK_00109230,Version);
...
code_r0x001027fd:
                  ...
                  do {
                    ...
                    *(undefined8 *)(puVar17 + -8) = 0x1024cc;
                    func_0x00101810(1,&UNK_00109315,(ulong)bVar4);
                ...
                *(int *)(puVar17 + 0x2c) = (int)cVar3;
                if (cVar3 == '\0') {
                  ...
                  *(undefined8 *)(puVar17 + -8) = 0x101d04;
                  uVar7 = func_0x00101660(0,&UNK_001092a4,5);
                  *(undefined8 *)(puVar17 + 0x20) = uVar7;
                  puVar23 = stdin;
                }
                else {
                  *(undefined8 *)(puVar17 + -8) = 0x102426;
                  puVar23 = (uint *)fopen_safer(*(undefined8 *)(puVar17 + 0x20),&UNK_00109280);
                        ...
                        if (status_only == '\0') {
                          ...
                          if (puVar17[0x7a] == '\0') {
                            ...
                            *(undefined8 *)(puVar17 + -8) = 0x10291e;
                            uVar7 = func_0x00101660(0,&UNK_001092fc,5);
...
code_r0x001021be:
                      ...
                      *(undefined8 *)(puVar17 + -8) = 0x102595;
                      uVar7 = func_0x00101660(0,&UNK_001092ed,5);
...
code_r0x00102383:
                    if (have_read_stdin != '\0') {
                      ...
                      *(undefined8 *)(puVar17 + -8) = 0x102728;
                      pbVar16 = (byte *)func_0x00101660(0,&UNK_001092a4,5);
...
code_r0x0010232d:
                                puVar19 = &UNK_001092e3;
                                goto code_r0x0010206b;
                              }
                            }
                            if (quiet == '\0') {
                              puVar19 = &UNK_001092ea;
                              goto code_r0x0010206b;
                            }
                          }
                        }
...
code_r0x00102390:
                    if (*(long *)(puVar17 + 0xe8) == *(long *)(in_FS_OFFSET + 0x28)) {
...
code_r0x00101e60:
                ...
                *(undefined8 *)(puVar17 + -8) = 0x101e91;
                uVar7 = func_0x00101660(0,&UNK_001092b3,5);
