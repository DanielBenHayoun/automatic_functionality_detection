...

{
  ...
  *param_3 = 0;
  ...
  if ((!bVar9 && !bVar10) == bVar9) {
    have_read_stdin = 1;
    fadvise(stdin,2);
    iVar2 = blake2b_stream(lVar5,param_2,b2_length >> 3);
    if (iVar2 != 0) {
code_r0x00103340:
      uVar3 = quotearg_n_style_colon(0,3,param_1);
      puVar4 = (uint *)func_0x00101810();
      func_0x00101ad0(0,(ulong)*puVar4,&UNK_00109f0c,uVar3);
      if (stdin == lVar5) {
        return 0;
      }
      rpl_fclose(lVar5);
    ...
    lVar5 = fopen_safer(param_1,&UNK_00109374);
    ...
    fadvise(lVar5,2);
    iVar2 = blake2b_stream(lVar5,param_2,b2_length >> 3);
    if (iVar2 != 0) goto code_r0x00103340;
