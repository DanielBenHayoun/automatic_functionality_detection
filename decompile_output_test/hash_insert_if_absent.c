...
code_r0x0010e6fd:
    ...
    if ((long)uVar11 < 0) {
      ...
      if (-1 < (long)uVar8) goto code_r0x0010e5b3;
code_r0x0010e63a:
      ...
      uVar8 = param_1[2];
      if ((long)uVar8 < 0) goto code_r0x0010e63a;
code_r0x0010e5b3:
      fVar16 = (float)uVar8;
    }
    ...
    if (fVar16 < (float)uVar7) {
      ...
      if ((float)uVar7 <= *(float *)(lVar5 + 8) * fVar16) goto code_r0x0010e5ca;
      fVar16 = fVar16 * *(float *)(lVar5 + 0xc);
      if (*(char *)(lVar5 + 0x10) == '\0') {
        fVar16 = fVar16 * *(float *)(lVar5 + 8);
      }
      uVar14 = SUB168(CONCAT124(auVar15,fVar16),0);
      if (fVar16 < _UNK_0011a02c) {
        if (_UNK_0011a030 <= fVar16) {
          uVar14 = SUB168(CONCAT124(auVar15,fVar16 - _UNK_0011a030),0);
          uVar10 = (long)(fVar16 - _UNK_0011a030) ^ 0x8000000000000000;
        }
        else {
          uVar10 = (ulong)fVar16;
        }
        ...
        if (cVar3 != '\0') {
          ...
          lVar5 = hash_find_entry(param_1,param_2,&puStack56,0);
          ppuVar2 = &puStack56;
          if (lVar5 != 0) goto code_r0x0010e6fd;
...
code_r0x0010e5ca:
    if (*puStack56 != 0) {
      ...
      if (puVar6 == (ulong *)0x0) {
        ...
        puVar6 = (ulong *)func_0x00103888();
        if (puVar6 == (ulong *)0x0) goto code_r0x0010e733;
      }
      else {
        param_1[9] = puVar6[1];
      }
    ...
    if ((lVar9 != 0) && (puVar12[4] = puVar12[4] + -1, *plStack120 == 0)) {
      ...
      if ((float)uVar7 < fVar16 * *(float *)puVar12[5]) {
        ...
        if ((float)uVar7 < *pfVar1 * fVar16) {
          ...
          if (_UNK_0011a030 <= fVar16) {
            uVar14 = SUB168(CONCAT124(auVar15,fVar16 - _UNK_0011a030),0);
            uVar11 = (long)(fVar16 - _UNK_0011a030) ^ 0x8000000000000000;
          }
          else {
            uVar11 = (ulong)fVar16;
          }
