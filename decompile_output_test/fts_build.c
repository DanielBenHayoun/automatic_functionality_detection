...
code_r0x00107ea0:
    ...
    if ((((*(uint *)(param_1 + 9) & 0x38) == 0x18) && (*(long *)(lVar12 + 0x88) == 2)) &&
      ...
      if (param_2 != 3) goto code_r0x00107ea0;
      bVar2 = false;
      bVar18 = true;
    }
    else {
  ...
  do {
    ...
    *piVar9 = 0;
    ...
    if (puVar10 == (undefined8 *)0x0) {
      ...
      if (*(long *)(lStack136 + 0x18) == 0) goto joined_r0x00107d10;
      func_0x00101b90();
...
code_r0x00107cb0:
    ...
    fts_lfree(lStack152);
    func_0x00101b90(*(undefined8 *)(lStack136 + 0x18));
    *(undefined8 *)(lStack136 + 0x18) = 0;
    lStack152 = 0;
      ...
      *(undefined8 *)(unaff_R13 + 0x80) = *puVar10;
      ...
      if ((uVar17 & 4) == 0) {
        ...
        *(undefined8 *)(unaff_R13 + 0x30) = *(undefined8 *)(unaff_R13 + 0x38);
        func_0x00101ce0(puStack104,unaff_R13 + 0x108,*(long *)(unaff_R13 + 0x60) + 1);
        uVar17 = *(uint *)(param_1 + 9);
      }
...
code_r0x001077f1:
  *(undefined8 *)(unaff_R13 + 0x10) = 0;
  ...
  if ((uVar11 == 10000) && (param_1[8] == 0)) {
    ...
    cStack74 = '\x01';
    lVar13 = unaff_R13;
    if (0x2711 < uStack112) goto code_r0x0010782f;
  }
  else {
code_r0x0010781b:
    uVar16 = uVar11 + 1;
    lVar13 = unaff_R13;
    if (uVar16 < uStack112) goto code_r0x0010782f;
  }
  uVar16 = uVar11 + 1;
joined_r0x00107d10:
  if (cStack75 != '\0') {
  ...
  if ((lVar1 == 0) && (cStack73 != '\0')) {
    if ((param_2 == 1) || (uVar16 == 0)) {
      if (*(long *)(lStack136 + 0x58) == 0) {
        ...
        iVar7 = fts_safe_changedir(param_1,*(undefined8 *)(lStack136 + 8),0xffffffff,&UNK_0010c4a1);
      }
