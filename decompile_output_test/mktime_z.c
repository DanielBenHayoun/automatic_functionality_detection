...

{
  ...
  if (param_1 == (long *)0x0) {
    lVar3 = func_0x00103720();
    goto code_r0x00115bae;
  }
  plVar7 = param_1;
  plVar8 = (long *)set_tz();
  if (plVar8 != (long *)0x0) {
    lStack96 = func_0x001036b0(param_2);
    if (lStack96 == -1) {
      plVar7 = &lStack96;
      lVar3 = func_0x001032c0();
      if (lVar3 != 0) {
