    ...
    do {
      while( true ) {
        ...
        *(long *)(param_2 + unaff_R15 * 8) = lVar14;
        ...
        if (param_4 == unaff_R15) goto code_r0x0010af96;
      }
      if (lVar14 != 0) {
        puVar15 = puVar15 + 8;
        puStack128 = &UNK_0010af45;
        puVar18 = unaff_R13;
        uVar7 = re_node_set_init_union(unaff_R13,puVar15,lVar14 + 8);
        uVar20 = (uint)param_5;
        uStack92 = (uint)uVar7;
        if (uStack92 != 0) goto code_r0x0010af98;
        puStack128 = &UNK_0010af5d;
        puVar15 = param_1;
        uVar5 = re_acquire_state(puStack112,param_1,unaff_R13);
        *(undefined8 *)(param_2 + unaff_R15 * 8) = uVar5;
        puStack128 = &UNK_0010af6b;
        puVar18 = puStack72;
        func_0x00101b00();
        uVar20 = (uint)param_5;
...
code_r0x0010af98:
  ...
  while (pplVar12 = pplVar10, (long)plVar16 < (long)pplVar13) {
    ...
    while (pplVar12 = pplVar11, (long)extraout_RDX <= lVar14) {
      if ((long)pplVar12 <= (long)plVar16) goto code_r0x0010b057;
    ...
    do {
      ...
      if (lVar14 != 0) {
        ...
        if (extraout_RDX == plVar23) {
          ...
          pplVar19 = pplVar10;
          if (lVar14 == 0) goto code_r0x0010b221;
        }
        else {
          ...
          if (lVar14 == 0) {
            ...
            lStack208 = 1;
            uStack200 = 1;
            pplStack192 = (long **)func_0x00101da0();
...
code_r0x0010b31c:
            ...
            *(long ***)pplStack192 = pplVar10;
            ...
            if (lVar6 != 0) goto code_r0x0010b1b9;
            ...
            if ((uStack212 != 0) || (cVar2 != '\x01')) {
              ...
              if (uStack212 == 0) goto code_r0x0010b31c;
              goto code_r0x0010b07f;
            }
          ...
          *plVar22 = lVar14;
          ...
          if ((*(long *)(*(long *)(puVar18 + 0xb8) + (long)plVar23 * 8) == 0) &&
             (uVar7 = (ulong)uStack212, uStack212 != 0)) goto code_r0x0010b07f;
        }
      }
code_r0x0010b1b9:
      pplVar11 = pplVar13 + 4;
  ...
  if (0 < (long)*pplVar10) {
    ...
    do {
      ...
      if (plVar21 == pplVar19[0x1e]) {
        ...
        plVar17 = (long *)func_0x00101e00(plVar17,(long)plVar21 << 4);
        if (plVar17 == (long *)0x0) {
          return 0xc;
        }
      ...
      pplVar9 = (long **)func_0x00101d30(1,0x30);
...
code_r0x0010b221:
  lStack208 = 1;
  uStack200 = 1;
  pplStack192 = (long **)func_0x00101da0(8);
  if (pplStack192 == (long **)0x0) {
    uStack200 = 0;
    lStack208 = 0;
    uStack212 = 0xc;
  ...
  func_0x00101b00();
  uVar7 = (ulong)uStack212;
  if ((uVar3 | uVar4 | uStack212) != 0) goto code_r0x0010b326;
