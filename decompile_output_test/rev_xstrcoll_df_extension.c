...
undefined8 rev_xstrcoll_df_extension(undefined8 *param_1,undefined8 *param_2)

{
  ...
  puVar7 = (undefined *)func_0x001034a0(*param_2,0x2e);
  puVar4 = (undefined *)func_0x001034a0(*param_1,0x2e);
