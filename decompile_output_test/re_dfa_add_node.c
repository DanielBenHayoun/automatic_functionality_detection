...
code_r0x00106bed:
    ...
    *(undefined8 *)(puVar1 + 4) = 0;
    ...
    if (uVar2 * 2 < 0xaaaaaaaaaaaaaab) {
      lVar4 = func_0x00101b30(*param_1,uVar2 << 5);
      if (lVar4 != 0) {
        *param_1 = lVar4;
        lVar4 = func_0x00101b30(param_1[3],uVar2 << 4);
        lVar5 = func_0x00101b30(param_1[4],uVar2 << 4);
        lVar6 = func_0x00101b30(param_1[5],uVar2 * 0x30);
        lVar7 = func_0x00101b30(param_1[6],uVar2 * 0x30);
        if ((((lVar4 != 0) && (lVar5 != 0)) && (lVar6 != 0)) && (lVar7 != 0)) {
          ...
          param_1[1] = uVar2 * 2;
          uVar8 = param_1[2];
          goto code_r0x00106bed;
        }
        func_0x00101880(lVar4);
        func_0x00101880(lVar5);
        func_0x00101880(lVar6);
        func_0x00101880(lVar7);
      }
    }
    lVar4 = -1;
  }
