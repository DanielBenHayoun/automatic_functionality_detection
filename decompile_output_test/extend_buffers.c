      ...
      if (((*(char *)((long)param_1 + 0x8a) == '\0') && (param_1[0xf] == 0)) &&
        ...
        if ((long)pbVar9 < (long)pbVar14) {
          do {
            ...
            bVar3 = *unaff_RBP;
            if (((bVar3 & 0x80) == 0) && (iVar5 = func_0x00101f10(plStack208), iVar5 != 0)) {
              plVar8 = (long *)func_0x00101ac0();
              ...
              *(uint *)(param_1[2] + (long)unaff_R13 * 4) = (uint)unaff_R13[param_1[1]];
              ...
              if (unaff_RBP + -1 < (byte *)0xfffffffffffffffd) {
                uVar4 = func_0x00101eb0((ulong)uStack148);
                if (uVar6 == uVar4) {
                  func_0x00101d70(unaff_R13 + param_1[1],unaff_R13 + *param_1 + param_1[5],unaff_RBP
                                 );
                }
                else {
                  pbVar9 = (byte *)func_0x00101db0(abStack136,(ulong)uVar4,&lStack144);
                  pbVar13 = unaff_R13;
                  if (unaff_RBP != pbVar9) goto code_r0x0010869e;
...
code_r0x0010869e:
          ...
          if (pbVar17 < (byte *)0xfffffffffffffffd) {
            ...
            if (uVar6 == uVar4) {
code_r0x00108a10:
              func_0x00101d70(pbVar13 + param_1[1],pbStack192,unaff_RBP);
            }
            else {
              pbVar18 = (byte *)func_0x00101db0(abStack136,(ulong)uVar4,&lStack144);
              if (unaff_RBP != pbVar18) {
                if (pbVar18 == (byte *)0xffffffffffffffff) goto code_r0x00108a10;
                if ((byte *)param_1[8] < pbVar18 + (long)pbVar13) goto code_r0x00108ab8;
                if (param_1[3] == 0) {
                  lVar11 = func_0x00101da0((long)(byte *)param_1[8] * 8);
                  param_1[3] = lVar11;
                  if (lVar11 == 0) {
                    uVar10 = 0xc;
                    goto code_r0x0010864f;
                ...
                func_0x00101d70(pbVar13 + param_1[1],abStack136,pbVar18,abStack136);
              ...
              func_0x00101d70(pbVar13 + param_1[1],abStack136,unaff_RBP);
            }
            pbVar17 = unaff_RBP + (long)unaff_R13;
            if (*(char *)((long)param_1 + 0x8c) != '\0') {
              lVar11 = param_1[3];
