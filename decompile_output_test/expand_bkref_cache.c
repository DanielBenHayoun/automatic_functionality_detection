...

{
  ...
  while (pplVar10 = pplVar8, (long)plVar13 < (long)pplVar11) {
    ...
    while (pplVar10 = pplVar9, (long)param_3 <= lVar12) {
      if ((long)pplVar10 <= (long)plVar13) goto code_r0x00108da7;
    ...
    do {
      ...
      if (lVar12 != 0) {
        ...
        if (param_3 == plVar18) {
          ...
          pplVar15 = pplVar8;
          if (lVar12 == 0) goto code_r0x00108f71;
        }
        else {
          ...
          if (lVar12 == 0) {
            ...
            lStack88 = 1;
            uStack80 = 1;
            pplStack72 = (long **)func_0x00101ac0();
...
code_r0x0010906c:
            ...
            *(long ***)pplStack72 = pplVar8;
            ...
            if (lVar5 != 0) goto code_r0x00108f09;
            ...
            if ((uStack92 != 0) || (cVar2 != '\x01')) {
              ...
              if (uStack92 == 0) goto code_r0x0010906c;
              goto code_r0x00108dcf;
            }
          ...
          *plVar17 = lVar12;
          ...
          if ((*(long *)(*(long *)(param_1 + 0xb8) + (long)plVar18 * 8) == 0) &&
             (uVar6 = (ulong)uStack92, uStack92 != 0)) goto code_r0x00108dcf;
        }
      }
code_r0x00108f09:
      pplVar9 = pplVar11 + 4;
  ...
  if (0 < (long)*pplVar8) {
    ...
    do {
      ...
      if (plVar16 == pplVar15[0x1e]) {
        ...
        plVar14 = (long *)func_0x00101b30(plVar14,(long)plVar16 << 4);
        if (plVar14 == (long *)0x0) {
          return 0xc;
        }
      ...
      pplVar11 = (long **)func_0x00101a70(1,0x30);
...
code_r0x00108f71:
  lStack88 = 1;
  uStack80 = 1;
  pplStack72 = (long **)func_0x00101ac0(8);
  if (pplStack72 == (long **)0x0) {
    uStack80 = 0;
    lStack88 = 0;
    uStack92 = 0xc;
  ...
  func_0x00101880();
  uVar6 = (ulong)uStack92;
  if ((uVar3 | uVar4 | uStack92) != 0) goto code_r0x00109076;
