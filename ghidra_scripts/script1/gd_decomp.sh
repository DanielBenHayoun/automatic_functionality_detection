...
GHIDRA_PATH=/home/daniel/ghidra_9.1.2_PUBLIC_20200212/ghidra_9.1.2_PUBLIC
...
time $GHIDRA_PATH/support/analyzeHeadless res tmp_ghidra_project -import $BINARY_PATH/$1 -postscript DecompileCUSTOM.java res/output.c -deleteProject -noanalysis
