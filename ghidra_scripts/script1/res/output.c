...
// WARNING: Removing unreachable block (ram,0x00400602)
// WARNING: Removing unreachable block (ram,0x00400608)
...
undefined8 authenticate(char *param_1,char *param_2)
...

{
  ...
  read(0,local_28,8);
  read(0,&local_2c,1);
  local_2c = authenticate(local_18,local_28,local_28);
  if (local_2c == 0) {
    rejected();
  }
  else {
